/**
 * Official IAB TCF v2.2 Stub
 * Source: https://github.com/InteractiveAdvertisingBureau/iabtcf-es/blob/master/modules/stub/src/stub.js
 *
 * This stub ensures __tcfapi is always available as a function (per TCF spec requirement)
 * and queues commands until the full CMP (Google Funding Choices) loads.
 */
(function () {
  const makeStub = () => {
