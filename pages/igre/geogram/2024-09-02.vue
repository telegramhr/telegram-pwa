<template>
  <div class="main-container flex single-article tg-games">
    ...
    <div class="full flex relative pretplata-page">
      ...
      >
        <h1 v-if="!$mobile" class="full center-text">Geogram | 02.09.2024.</h1>
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      geogramImage: '@/assets/img/games/geogram/geogram_2.jpg',
      geogramLocation: 'Park Maksimir, Zagreb',
      geogramAuthor: 'Marijan Mikolić',
      mapcoords: `45°49'55.0"N 16°01'26.3"E`,
      finalScore: 0,
      locatorPosition: {
