<template>
  ...
  >
    ...
    <div
      class="full center relative dark-mode pretplata-bf full-height column-full-pad mobile-full-pad"
    >
      <img
      ...
      <div class="container smaller-container center relative mobile-side-pad">
        <div class="full center relative mobile-bottom-pad">
          ...
          <div class="full flex hide">
            <h1 class="full center-text">Cyber Monday na Telegramu</h1>
            <div class="full nothone center-text">-50%</div>
          </div>
        </div>
        <div
          class="two-thirds column-full-pad flex-responsive flex relative stretch m-order-2 mobile-bottom-pad"
        >
          <div class="full flex overtitle-parent hide">
          ...
          <div class="full pretplata-benefits">
            ...
            <p class="full animate">
              <font-awesome-icon :icon="['fas', 'check']"></font-awesome-icon>
              Pristup člancima najboljih autora u Hrvatskoj
            </p>
            <p class="full animate">
              <font-awesome-icon :icon="['fas', 'check']"></font-awesome-icon>
        ...
        >
          <img
            ...
            alt="Screenshot Telegram naslovnice"
          />
        </div>
      </div>
    </div>
  ...
  computed: {
    ...
    jsonld() {
      return {
        ...
        description: 'Dvije godine premium pretplate za cijenu jedne! ',
    ...
    const link = [
      {
        hid: 'canonical',
        rel: 'canonical',
        href: 'https://www.telegram.hr/pretplata/cyber-monday/',
      },
    ]
    return {
      title: 'Dvije godine premium pretplate za cijenu jedne! ',
      titleTemplate: '%s | Telegram.hr',
      meta: [
        {
          hid: 'description',
          name: 'description',
          content: 'Cyber Monday na Telegramu: -50%',
        },
        {
          hid: 'og:description',
        ...
        },
        {
          ...
          property: 'og:image',
          content:
            'https://www.telegram.hr/wp-content/uploads/2023/11/tg-naslovna-2023-11-27-cm.jpg',
        },
        {
          hid: 'og:title',
          property: 'og:title',
        ...
        },
        {
          hid: 'og:url',
          property: 'og:url',
          content: 'https://www.telegram.hr/pretplata/cyber-monday/',
        },
      ],
      link,
    }
