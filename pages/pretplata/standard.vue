<template>
  <div>
    ...
    <PretplataHeroStandard
      title="Čitajte Telegram cijelu godinu za 29€"
      text="Do neovisnog novinarstva sada možete 
već od  "
      highlighted-text="0.56€"
      image-src="devices.png"
      background-color="#810A06"
      duration="6:25 min"
      disclaimer="Nakon isteka prve godine po cijeni od 29€, pretplata se automatski obnavlja po redovnoj cijeni."
      button="Aktivirajte pretplatu"
      :logo="true"
    ></PretplataHeroStandard>
    <div class="content">
