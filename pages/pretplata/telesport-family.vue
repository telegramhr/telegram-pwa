<template>
  <div>
    <div class="hero-family-telesport center">
      <img
        class="bg-image img-as-bg"
        :src="hero.background"
        alt="Hero Background"
      />
      ...
      <div class="content">
        ...
        />
        <div class="hero-family-wrapper-telesport">
          <span class="novo-badge">Novo</span>
          <div class="hero-family-info-telesport">
            <h2>{{ hero.title }}</h2>
...
export default {
  ...
  data() {
    return {
      hero: {
        logo: require('@/assets/img/telesport-logo-transparent.png'),
      ...
      steps: [
        ...
        {
          image: require('@/assets/img/telesport_2clana.png'),
