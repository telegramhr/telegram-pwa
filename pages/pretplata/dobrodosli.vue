        ...
        >
          <div class="full flex single-article-body">
            <h1 class="full center-text column-bottom-pad">
              Plaćanje uspješno: vaša pretplata je aktivna
            </h1>
            <p
            ...
            <h2 class="full">
              Ne propustite Telegramove vijesti i autorske članke
            </h2>
            <p class="full">
              Pretplatite se na jedan od naših popularnih newslettera:
            </p>
            <div class="full flex relative">
              ...
              >
                ...
                <div class="minicard-input center">
                  <input id="dnevni" type="checkbox" class="cbx" />
              ...
              >
                ...
                <div class="minicard-input center">
                  <input id="propustili" type="checkbox" class="cbx" />
              ...
              >
                ...
                <div class="minicard-input center">
                  <input id="vikend" type="checkbox" class="cbx" />
