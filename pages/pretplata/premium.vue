  ...
  >
    ...
    <div id="pretplata-selector" class="full flex">
      <div class="full flex relative">
        ...
        >
          <h1 class="full center-text">Čitajte Telegram bez oglasa</h1>
          <p class="full center-text pretplata-tagline">
            Pretplatite se na naš Premium paket za najbolje iskustvo Telegrama
          </p>
        </div>
        <div class="full flex">
            ...
            <div class="full flex center pretplata-packboxes">
              <div class="full center">
                <input
                  ...
                  name="pretplata-year"
                  class="hide"
                  value="pretplata-year"
                />
                <label
                  for="pretplata-year"
                  class="half flex-responsive flex relative pretplata-packbox smaller-packbox stretch"
                >
                  <div class="best-price-sticker bigger-sticcer animate">
                    2 mjeseca<br />besplatno
                  </div>
                  <div class="smaller-packbox-radio">
                    <div class="remp-radio-indicator center"><div></div></div>
                  </div>
                  <div class="full sub-price bold">
                    99€<span> godišnje</span>
                  </div>
                </label>
              </div>
              <div class="full center">
...
export default {
  ...
  data() {
    return {
      promo_code: '',
      subscription_package: 'pretplata-month',
    }
  },
  computed: {
    one() {
