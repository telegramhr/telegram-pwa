    ...
    <client-only>
      ...
      >
        ...
        <div class="container smaller-container relative flex stretch">
          <div
            class="sixty flex-responsive flex center m-order-2 mobile-full-pad"
          >
            ...
            <p class="full newbook-intro desktop-only">
              <span class="ib">Ovih praznika počastite se pretplatom, </span
              ><span class="ib">po najboljoj božićnoj cijeni</span>
            </p>
          ...
          <div
            class="forty flex-responsive flex center m-order-1 mobile-side-pad"
          >
            <img
      ...
      <app-link
        ...
        class="full flex relative center newbook-xmas newbook-gifting newbook-compact column-full-pad dark-mode"
      >
        <img
          src="@/assets/img/tg_visual_2023_xmasbg_green.jpg"
          class="img-as-bg"
