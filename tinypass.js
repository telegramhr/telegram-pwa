window.pnInitPerformance = performance.now(),
  window.___tp = function() {
    ...
    tp = function() {
      function t() {
        function i(e, t, r) {
          ...
          for (var u = 0; u < n.length; u++) {
            var a = n[u];
            e === a.module && t.substring(0, a.prefix.length) === a.prefix && (i = t.substring(a.prefix.length, a.prefix.length + 1).toLowerCase() + t.substring(a.prefix.length + 1, t.length),
      ...
      this.aid = "",
        ...
        ,
        this.isSensitiveDataProtectionEnabled = !1,
        this.enableSensitiveDataProtection = function(e) {
        ...
        this.setGAClientId = function(e) {
          this.gaClientId = e,
          this.gaService && this.gaService.recreateWithClientId(e)
        }
        ,
        ...
        this.enableGACrossDomainLinking = function(e) {
          var t = this;
                ...
                o(function(n) {
                  if (typeof n != "undefined" && typeof e == "undefined")
                    ...
                    for (var i = 0; i < r.length; i++) {
                      var s = r[i];
                      if (s.get("trackingId") === e) {
                        t.setGAClientId(s.get("clientId"));
                        break
                      }
                    }
                  }
        ...
        ,
        this.composerHost = "",
        this.setComposerHost = function(e) {
          this.composerHost = e
        }
        ,
        this.endpoint = "",
        ...
        this.setAffiliateTokenName = function(e) {
        ...
        ,
        this.cacheableShowTemplate = !1,
        this.setCacheableShowTemplate = function(e) {
        ...
        this.setCustomParam = function(e, t, n, r) {
          ...
          if (this.customParams[n][e] === undefined || r)
            this.customParams[n][e] = [];
          var s = [].concat(t);
          ...
          if (this.isInitialized)
            ...
            if (typeof e == "string")
              ...
              for (var n = 0; n < e.length; ++n)
                this.externalLibraries.push(e[n]);
          ...
          this.locale = e,
            tp.push(["init", function() {
              tp.pianoId.isConfigured() && tp.pianoId.updateLang(e),
                tp.postmessage.broadcast("langChanged", {
                  lang: e
                })
            }
            ])
        ...
        (function(ba) {
            ...
            function U(e, n, r, i) {
              return n && B(n, function(n, s) {
                if (r || !t(e, s))
                  i && "object" == typeof n && n && !H(n) && !G(n) && !(n instanceof RegExp) ? (e[s] || (e[s] = {}),
                    U(e[s], n, r, i)) : e[s] = n
              }),
                e
            }
            ...
            function ga(e) {
              function n(e, t, n) {
                var r, i, s, o, u, a, f, l, t = t && t.split("/"), c = A.map, h = c && c["*"];
                if (e) {
                  e = e.split("/"),
                    i = e.length - 1,
                  A.nodeIdCompat && Q.test(e[i]) && (e[i] = e[i].replace(Q, "")),
                  "." === e[0].charAt(0) && t && (i = t.slice(0, t.length - 1),
                    e = i.concat(e)),
                    i = e;
                  for (s = 0; s < i.length; s++)
                    (o = i[s],
                    "." === o) ? (i.splice(s, 1),
                      s -= 1) : ".." === o && 0 !== s && (1 != s || ".." !== i[2]) && ".." !== i[s - 1] && 0 < s && (i.splice(s - 1, 2),
                      s -= 2);
                  e = e.join("/")
                }
                if (n && c && (t || h)) {
              ...
              function o(e, t, r, i) {
                var o, u, a = null, f = t ? t.name : null, l = e, c = !0, h = "";
                return e || (c = !1,
                  e = "_@r" + (q += 1)),
                  e = s(e),
                  a = e[0],
                ...
                e && (a ? h = u && u.normalize ? u.normalize(e, function(e) {
                  return n(e, f, i)
                }) : -1 === e.indexOf("!") ? n(e, f, i) : e : (h = n(e, f, i),
                  e = s(h),
                  a = e[0],
                  h = e[1],
                  r = !0,
              ...
              function f(e, n, r) {
                var i = e.id
                  , s = m(O, i);
                t(j, i) && (!s || s.defineEmitComplete) ? "defined" === n && r(j[i]) : (s = a(e),
                s.error && "error" === n) ? r(s.error) : s.on(n, r)
              }
              function l(e, t) {
              ...
              function c() {
                R.length && (ha.apply(P, [P.length, 0].concat(R)),
                  R = [])
              }
              function h(e) {
                delete O[e],
              ...
              function p(e, t, n) {
                ...
                e.error ? e.emit("error", e.error) : (t[r] = !0,
                  v(e.depMaps, function(r, i) {
                    var s = r.id
                      , o = m(O, s);
                    o && !e.depMatched[i] && !n[s] && (m(t, s) ? (e.defineDep(i, j[s]),
                      e.check()) : p(o, t, n))
                  }),
                  n[r] = !0)
              }
              function d() {
                var e, t, n = (e = 1e3 * A.waitSeconds) && x.startTime + e < (new Date).getTime(), s = [], o = [], u = !1, a = !0;
                if (!E) {
                  E = !0,
                    B(_, function(e) {
                      var f = e.map
              ...
              return k = {
                        ...
                        if (this.error)
                          ...
                          if (1 > this.depCount && !this.defined) {
                            if (G(i)) {
                              ...
                              r = i;
                            this.exports = r,
                            this.map.isDefine && !this.ignore && (j[n] = r,
                ...
                x = {
                  ...
                  makeRequire: function(i, s) {
                    function u(n, r, f) {
                      ...
                      return s.enableBuildCallback && r && G(r) && (r.__requireJsBuild = !0),
                        "string" == typeof n ? G(r) ? l(C("requireargs", "Invalid require call"), f) : i && t(k, n) ? k[n](O[i.id]) : g.get ? g.get(x, n, i, u) : (c = o(n, i, !1, !0),
                          c = c.id,
                          t(j, c) ? j[c] : l(C("notloaded", 'Module name "' + c + '" has not been loaded yet for context: ' + e + (i ? "" : ". Use require([])")))) : (w(),
                          x.nextTick(function() {
                            w(),
                              h = a(o(null, i)),
                              h.skipMap = s.skipMap,
                    ...
                    return s = s || {},
                      U(u, {
                        ...
                        toUrl: function(e) {
                          ...
                          return -1 !== r && ("." !== s && ".." !== s || 1 < r) && (t = e.substring(r, e.length),
                            e = e.substring(0, r)),
                    ...
                    i || (u.undef = function(e) {
                        ...
                        n && (n.events.defined && (D[e] = n.events),
                          h(e))
                      }
                    ),
                      u
                  ...
                  completeLoad: function(e) {
                    var n, r, s = m(A.shim, e) || {}, o = s.exports;
                    for (c(); P.length; ) {
                      r = P.shift();
                      if (null === r[0]) {
                        r[0] = e;
            ...
            if ("undefined" == typeof define) {
              ...
              z && (y = x.head = document.getElementsByTagName("head")[0],
                ...
                g.load = function(e, t, n) {
                  var r = e && e.config || {};
                  if (z)
                    return r = g.createNode(r, t, n),
                      r.setAttribute("data-requirecontext", e.contextName),
                      r.setAttribute("data-requiremodule", t),
                      r.attachEvent && !(r.attachEvent.toString && 0 > r.attachEvent.toString().indexOf("[native code")) && !Y ? (M = !0,
            ...
            tp.prototype = function() {
              ...
              var e = []
                ...
                if (tp.sandbox === !0)
                  ...
                  n = "https://api-v3.tinypass.com";
                return t(n, !0)
              }
                , o = function(e) {
                var n = "https://experience.tinypass.com";
                return tp.composerHost ? n = tp.composerHost : (tp.sandbox === !0 && (tp.endpoint = "sandbox"),
                tp.endpoint && (tp.endpoint === "sandbox" ? n = "https://sandbox.tinypass.com" : tp.endpoint !== "prod" && tp.endpoint !== "production" && (n = tp.endpoint,
                ...
                , u = function() {
                return tp.sandbox || tp.endpoint === "sandbox" || !!tp.endpoint && tp.endpoint.indexOf("//sandbox.tinypass.com") !== -1
              }
                , a = {
                constructor: tp,
                ...
                getTrackingEndpoint: function(e) {
                  return s(e)
                },
                isSandbox: function() {
                  return u()
              ...
              return a.require = require,
                a.define = define,
                a.loadRequireJs = function(e) {
                  a.isInitRequired = !0;
                  var t = ["jq", "main", "api", "logging", "offer", "template", "myaccount", "require-css/css", "util", "postmessage", "user", "meter", "fingerprint", "jwtDecode", "janrain", "gigya", "tinypassAccounts", "tinypassLogin", "containerUtils", "eventUtils", "experience", "activetimer", "scrollDepth", "ifvisible", "doubleClickForPublisher", "viewportExit", "condeUserProvider", "log", "pianoId", "pianoIdLite", "observer", "applePay", "applePayIntegrationService", "stripeApplePayIntegrationService", "obi3DSChallenge", "idle", "gaService", "interaction", "pianoEsp", "versionService", "amp", "performanceMetrics", "swg", "fbpixel", "fbsubscriptions", "doubleOptIn", "tinypassErrorHandler", "newscycle", "cxense", "recWidgetService", "sha1", "itp", "captchaV3"];
                  ...
                  window.tp.require.config({
                    ...
                    tp.require(["jq", "main", "api", "logging", "offer", "template", "myaccount", "require-css/css", "util", "postmessage", "user", "meter", "fingerprint", "jwtDecode", "janrain", "gigya", "tinypassAccounts", "tinypassLogin", "containerUtils", "eventUtils", "experience", "activetimer", "scrollDepth", "ifvisible", "doubleClickForPublisher", "viewportExit", "condeUserProvider", "pianoId", "pianoIdLite", "observer", "applePay", "applePayIntegrationService", "stripeApplePayIntegrationService", "obi3DSChallenge", "idle", "interaction", "require-css/css!styles/offer", "log", "gaService", "pianoEsp", "versionService", "amp", "performanceMetrics", "swg", "fbpixel", "fbsubscriptions", "doubleOptIn", "tinypassErrorHandler", "newscycle", "cxense", "recWidgetService", "sha1", "itp", "captchaV3"], function(t) {
                      var n;
                      window.tp.require.config({
                        baseUrl: i(),
                        urlArgs: tp.debug ? "cachebust=" + (new Date).getTime() : ""
                      ...
                      for (n = 0; n < arguments.length; ++n) {
                        if (!arguments[n] || !arguments[n].name)
                          continue;
                        if (arguments[n].name === "main" && !arguments[n].init)
                          continue;
                  ...
                  try {
                    ...
                    if (!tp.isRequireLoaded) {
                      for (var i = 0; i < n.length; i++)
                        tp.initCallbacks.push(function(e) {
                          return function() {
                            try {
                              n[e]()
                            } catch (t) {
                              console.error(t),
                                tp.tinypassErrorHandler.addError(t)
                            }
                          }
                        }(i));
                      setTimeout(function() {
                      ...
                      if (tp.util.isSafariOrIOsUiWebView() && !tp.user.isUserValid() && tp.util.getQueryParamByName("userToken")) {
                        var s = tp.util.getQueryParamByName("cookieDomain")
                          , o = tp.util.getQueryParamByName("userToken")
                          , u = tp.util.getQueryParamByName("tokenListValue");
                      ...
                      for (t = 0; t < tp.initCallbacks.length; ++t)
                        try {
                          ...
                          console.error(f),
                            tp.tinypassErrorHandler.addError(f)
                        }
                      tp.isInitialized = !0,
                        tp.initCallbacks = [];
                      if (tp.events) {
                        for (t = 0; t < tp.events.length; t++)
                          tp.events[t]();
                        tp.events = []
                      }
                      for (var i = 0; i < n.length; i++)
                      ...
                      tp.appList.indexOf(tp.aid) < 0 && (tp.appList.push(tp.aid),
                        tp.main.init());
                      if (!a) {
                        var l = r() + "/anon/error/log";
                        tp.log.logBeaconRequest(l, {
                          log_message: "Incorrect aid integration: " + tp.aid + " url: " + window.location.href
                        })
                      }
                      tp.logging.setTime("completeInit")
                    }
                  } catch (c) {
                    tp.tinypassErrorHandler.addError(c, "initTP")
                  }
                }
                ,
                a.init = function(e) {
  ...
  function(e) {
    (function(e, t) {
      ...
      function H() {
        r.addEventListener ? (r.removeEventListener("DOMContentLoaded", B),
          e.removeEventListener("load", B)) : (r.detachEvent("onreadystatechange", B),
      ...
      function K(e, t, n, r) {
        var i, s = 1, o = 20, u = r ? function() {
          ...
          , a = u(), f = n && n[3] || (p.cssNumber[t] ? "" : "px"), l = (p.cssNumber[t] || f !== "px" && +a) && V.exec(p.css(e, t));
        if (l && l[3] !== f) {
          f = f || l[3],
            n = n || [],
            l = +a || 1;
      ...
      function it(e, t) {
        var n, r, i = 0, s = typeof e.getElementsByTagName != "undefined" ? e.getElementsByTagName(t || "*") : typeof e.querySelectorAll != "undefined" ? e.querySelectorAll(t || "*") : undefined;
        if (!s)
          for (s = [],
      ...
      function ft(e, t, n, r, i) {
        var s, o, u, a, f, l, h, d = e.length, v = nt(t), m = [], g = 0;
        for (; g < d; g++) {
          o = e[g];
          if (o || o === 0)
            if (p.type(o) === "object")
              ...
              if (!c.tbody) {
                o = f === "table" && !ut.test(o) ? a.firstChild : h[1] === "<table>" && !ut.test(o) ? a : 0,
                  s = o && o.childNodes.length;
                while (s--)
                  p.nodeName(l = o.childNodes[s], "tbody") && !l.childNodes.length && o.removeChild(l)
              }
              p.merge(m, a.childNodes),
                a.textContent = "";
              while (a.firstChild)
        ...
        a && v.removeChild(a),
        c.appendChecked || p.grep(it(m, "input"), at),
          g = 0;
        while (o = m[g++]) {
      ...
      function Dt(e, t, n, r) {
        t = s.apply([], t);
        var i, o, u, a, f, l, h = 0, d = e.length, v = d - 1, m = t[0], g = p.isFunction(m);
        ...
        if (d) {
          ...
          if (i || r) {
            a = p.map(it(l, "script"), At),
              u = a.length;
            for (; h < d; h++)
              o = l,
              h !== v && (o = p.clone(o, !0, !0),
              u && p.merge(a, it(o, "script"))),
                n.call(e[h], o, h);
            if (u) {
              ...
              for (h = 0; h < u; h++)
                o = a[h],
                Z.test(o.type || "") && !p._data(o, "globalEval") && p.contains(f, o) && (o.src ? p._evalUrl && p._evalUrl(o.src) : p.globalEval((o.text || o.textContent || o.innerHTML || "").replace(Nt, "")))
            }
            l = i = null
          }
        }
      ...
      function Pt(e, t, n) {
        var r, i = t ? p.filter(t, e) : e, s = 0;
        for (; (r = i[s]) != null; s++)
          !n && r.nodeType === 1 && p.cleanData(it(r)),
          r.parentNode && (n && p.contains(r.ownerDocument, r) && st(it(r, "script")),
      ...
      function Ft(e) {
        ...
        if (!n) {
          n = jt(e, t);
          if (n === "none" || !n)
            Ht = (Ht || p("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement),
      ...
      function nn(e, t) {
        ...
        for (; o < u; o++) {
          ...
          s[o] = p._data(r, "olddisplay"),
            ...
            r.style.display === "" && J(r) && (s[o] = p._data(r, "olddisplay", Ft(r.nodeName)))) : (i = J(r),
      ...
      function sn(e, t, n, r, i) {
        ...
        for (; s < 4; s += 2)
          n === "margin" && (o += p.css(e, n + $[s], !0, i)),
            r ? (n === "content" && (o -= p.css(e, "padding" + $[s], !0, i)),
            n !== "margin" && (o -= p.css(e, "border" + $[s] + "Width", !0, i))) : (o += p.css(e, "padding" + $[s], !0, i),
      ...
      function dn(e, t, n) {
        var r, i = (gn.tweeners[t] || []).concat(gn.tweeners["*"]), s = 0, o = i.length;
        for (; s < o; s++)
          if (r = i[s].call(n, t, e))
            return r
      }
      function vn(e, t, n) {
        var r, i, s, o, u, a, f, l, h = this, d = {}, v = e.style, m = e.nodeType && J(e), g = p._data(e, "fxshow");
        ...
        l === "inline" && p.css(e, "float") === "none" && (!c.inlineBlockNeedsLayout || Ft(e.nodeName) === "inline" ? v.display = "inline-block" : v.zoom = 1)),
        ...
        if (!p.isEmptyObject(d)) {
          ...
          (f === "none" ? Ft(e.nodeName) : f) === "inline" && (v.display = f)
      }
      function mn(e, t) {
        var n, r, i, s, o;
        for (n in e) {
      ...
      function gn(e, t, n) {
        var r, i, s = 0, o = gn.prefilters.length, u = p.Deferred().always(function() {
          delete a.elem
        }), a = function() {
          if (i)
            return !1;
        ...
        for (; s < o; s++) {
          ...
          if (r)
            return p.isFunction(r.stop) && (p._queueHooks(f.elem, f.opts.queue).stop = p.proxy(r.stop, r)),
              r
        }
        return p.map(l, dn, f),
      ...
      function Vn(e) {
        return function(t, n) {
          typeof t != "string" && (n = t,
            t = "*");
          var r, i = 0, s = t.toLowerCase().match(_) || [];
          if (p.isFunction(n))
            while (r = s[i++])
      ...
      p.fn = p.prototype = {
        ...
        p.extend({
          ...
          makeArray: function(e, t) {
            var n = t || [];
            return e != null && (y(Object(e)) ? p.merge(n, typeof e == "string" ? [e] : e) : o.call(n, e)),
              n
          },
          ...
          proxy: function(e, t) {
            ...
            return typeof t == "string" && (s = e[t],
              t = e,
              e = s),
              p.isFunction(e) ? (n = i.call(arguments, 2),
                r = function() {
      ...
      var C, k = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, L = p.fn.init = function(e, t, n) {
          var i, s;
          if (!e)
            return this;
          n = n || C;
            ...
            if (i && (i[1] || !t)) {
              if (i[1]) {
                t = t instanceof p ? t[0] : t,
                  p.merge(this, p.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : r, !0));
          ...
          return e.nodeType ? (this.context = this[0] = e,
            this.length = 1,
            this) : p.isFunction(e) ? typeof n.ready != "undefined" ? n.ready(e) : e(p) : (e.selector !== undefined && (this.selector = e.selector,
      ...
      p.fn.extend({
        ...
        closest: function(e, t) {
          var n, r = 0, i = this.length, s = [], o = S.test(e) || typeof e != "string" ? p(e, t || this.context) : 0;
          for (; r < i; r++)
        ...
        p.each({
          ...
          p.fn[e] = function(n, r) {
            ...
            this.length > 1 && (O[e] || (i = p.uniqueSort(i)),
      ...
      p.Callbacks = function(e) {
        ...
        p.extend({
          ...
          when: function(e) {
            var t = 0, n = i.call(arguments), r = n.length, s = r !== 1 || e && p.isFunction(e.promise) ? r : 0, o = s === 1 ? e : p.Deferred(), u = function(e, t, n) {
              return function(r) {
                t[e] = this,
            ...
            if (r > 1) {
              a = new Array(r),
                ...
                l = new Array(r);
              for (; t < r; t++)
                n[t] && p.isFunction(n[t].promise) ? n[t].promise().progress(u(t, f, a)).done(u(t, l, n)).fail(o.reject) : --s
            }
        ...
        p.extend({
          ...
          ready: function(e) {
            ...
            if (e !== !0 && --p.readyWait > 0)
              return;
            P.resolveWith(r, [p]),
            p.fn.triggerHandler && (p(r).triggerHandler("ready"),
              p(r).off("ready"))
          }
        }),
        p.ready.promise = function(t) {
          if (!P) {
            ...
            if (r.readyState === "complete" || r.readyState !== "loading" && !r.documentElement.doScroll)
              ...
              r.attachEvent("onreadystatechange", B),
      ...
      (function() {
          ...
          for (t in {
            ...
            n = "on" + t,
            (c[t] = n in e) || (i.setAttribute(n, "t"),
              c[t] = i.attributes[n].expando === !1);
          i = null
        }
      )();
      ...
      p.event = {
        ...
        trigger: function(t, n, i, s) {
          var o, u, a, f, c, h, d, v = [i || r], m = l.call(t, "type") ? t.type : t, g = l.call(t, "namespace") ? t.namespace.split(".") : [];
          a = h = i = i || r;
          if (i.nodeType === 3 || i.nodeType === 8)
            return;
          if (pt.test(m + p.event.triggered))
            return;
          m.indexOf(".") > -1 && (g = m.split("."),
            m = g.shift(),
            g.sort()),
            u = m.indexOf(":") < 0 && "on" + m,
          ...
          t.target || (t.target = i),
            ...
            c = p.event.special[m] || {};
          if (!s && c.trigger && c.trigger.apply(i, n) === !1)
            return;
          if (!s && !c.noBubble && !p.isWindow(i)) {
            f = c.delegateType || m,
            pt.test(f + m) || (a = a.parentNode);
          ...
          while ((a = v[d++]) && !t.isPropagationStopped())
            ...
            o && o.apply(a, n),
              o = u && a[u],
            o && o.apply && F(a) && (t.result = o.apply(a, n),
        ...
        dispatch: function(e) {
          e = p.event.fix(e);
          var t, n, r, s, o, u = [], a = i.call(arguments), f = (p._data(this, "events") || {})[e.type] || [], l = p.event.special[e.type] || {};
          a[0] = e,
          ...
          while ((s = u[t++]) && !e.isPropagationStopped()) {
            ...
            while ((o = s.handlers[n++]) && !e.isImmediatePropagationStopped())
              if (!e.rnamespace || e.rnamespace.test(o.namespace))
                e.handleObj = o,
                  e.data = o.data,
                  r = ((p.event.special[o.origType] || {}).handle || o.handler).apply(s.elem, a),
            ...
            for (; a != this; a = a.parentNode || this)
              if (a.nodeType === 1 && (a.disabled !== !0 || e.type !== "click")) {
                ...
                for (n = 0; n < u; n++)
                  s = t[n],
                    i = s.selector + " ",
                  r[i] === undefined && (r[i] = s.needsContext ? p(i, this).index(a) > -1 : p.find(i, this, null, [a]).length),
                  r[i] && r.push(s);
                r.length && o.push({
                  elem: a,
                  handlers: r
        ...
        fix: function(e) {
          if (e[p.expando])
            return e;
          var t, n, i, s = e.type, o = e, u = this.fixHooks[s];
          u || (this.fixHooks[s] = u = ht.test(s) ? this.mouseHooks : ct.test(s) ? this.keyHooks : {}),
          ...
          while (t--)
            n = i[t],
              e[n] = o[n];
          return e.target || (e.target = o.srcElement || r),
        ...
        mouseHooks: {
          ...
          filter: function(e, t) {
            var n, i, s, o = t.button, u = t.fromElement;
            return e.pageX == null && t.clientX != null && (i = e.target.ownerDocument || r,
              s = i.documentElement,
              n = i.body,
        ...
        p.Event = function(e, t) {
          ...
          e && e.type ? (this.originalEvent = e,
            this.type = e.type,
            this.isDefaultPrevented = e.defaultPrevented || e.defaultPrevented === undefined && e.returnValue === !1 ? vt : mt) : this.type = e,
          t && p.extend(this, t),
      ...
      p.extend({
        ...
        clone: function(e, t, n) {
          ...
          c.html5Clone || p.isXMLDoc(e) || !wt.test("<" + e.nodeName + ">") ? s = e.cloneNode(!0) : (kt.innerHTML = e.outerHTML,
            kt.removeChild(s = kt.firstChild));
          ...
          if (t)
            if (n) {
              ...
              Mt(e, s);
          return r = it(s, "script"),
          r.length > 0 && st(r, !a && it(e, "script")),
            r = u = i = null,
            s
        },
        cleanData: function(e, t) {
          var r, i, s, o, u = 0, a = p.expando, f = p.cache, l = c.attributes, h = p.event.special;
          for (; (r = e[u]) != null; u++)
            if (t || F(r)) {
              s = r[a],
                o = s && f[s];
              if (o) {
                ...
                f[s] && (delete f[s],
                  !l && typeof r.removeAttribute != "undefined" ? r.removeAttribute(a) : r[a] = undefined,
                  n.push(s))
              }
            }
        }
        ...
        p.fn.extend({
            ...
            return Q(this, function(e) {
              ...
              if (typeof e == "string" && !St.test(e) && (c.htmlSerialize || !wt.test(e)) && (c.leadingWhitespace || !et.test(e)) && !rt[(Y.exec(e) || ["", ""])[1].toLowerCase()]) {
                ...
                try {
                  for (; n < r; n++)
                    t = this[n] || {},
                    t.nodeType === 1 && (p.cleanData(it(t, !1)),
                      t.innerHTML = e);
                  t = 0
                } catch (i) {}
              }
          ...
          replaceWith: function() {
            ...
            return Dt(this, arguments, function(t) {
              ...
              p.inArray(this, e) < 0 && (p.cleanData(it(this)),
        ...
        p.each({
          ...
          p.fn[e] = function(e) {
            var n, r = 0, i = [], s = p(e), u = s.length - 1;
            for (; r <= u; r++)
      ...
      var Ht, Bt = {
        HTML: "block",
        BODY: "block"
      }, It = /^margin/, qt = new RegExp("^(" + X + ")(?!px)[a-z%]+$","i"), Rt = function(e, t, n, r) {
        var i, s, o = {};
        for (s in t)
          o[s] = e.style[s],
            e.style[s] = t[s];
      ...
      (function() {
          function l() {
            ...
            h.appendChild(a),
              ...
              t = i = u = !1,
              n = o = !0,
            e.getComputedStyle && (c = e.getComputedStyle(f),
              t = (c || {}).top !== "1%",
              u = (c || {}).marginLeft === "2px",
              i = (c || {
                width: "4px"
              ...
              l.style.cssText = f.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0",
          ...
          var t, n, i, s, o, u, a = r.createElement("div"), f = r.createElement("div");
          if (!f.style)
            return;
          f.style.cssText = "float:left;opacity:.5",
            ...
            f.innerHTML = "",
            a.appendChild(f),
            c.boxSizing = f.style.boxSizing === "" || f.style.MozBoxSizing === "" || f.style.WebkitBoxSizing === "",
            p.extend(c, {
      ...
      e.getComputedStyle ? (zt = function(t) {
          ...
          Wt = function(e, t, n) {
            ...
            (o === "" || o === undefined) && !p.contains(e.ownerDocument, e) && (o = p.style(e, t)),
            n && !c.pixelMarginRight() && qt.test(o) && It.test(t) && (r = u.width,
              i = u.minWidth,
              s = u.maxWidth,
      ...
      p.extend({
        ...
        style: function(e, t, n, r) {
          ...
          s = typeof n,
          s === "string" && (i = V.exec(n)) && i[1] && (n = K(e, t, i),
            s = "number");
          if (n == null || n !== n)
            return;
        ...
        css: function(e, t, n, r) {
          ...
          return t = p.cssProps[u] || (p.cssProps[u] = tn(u) || u),
            o = p.cssHooks[t] || p.cssHooks[u],
        ...
        p.each(["height", "width"], function(e, t) {
          p.cssHooks[t] = {
            get: function(e, n, r) {
              if (n)
                return Kt.test(p.css(e, "display")) && e.offsetWidth === 0 ? Rt(e, Gt, function() {
                  return on(e, t, r)
                }) : on(e, t, r)
            },
            set: function(e, n, r) {
      ...
      c.opacity || (p.cssHooks.opacity = {
        ...
        p.cssHooks.marginLeft = Vt(c.reliableMarginLeft, function(e, t) {
          if (t)
            return (parseFloat(Wt(e, "marginLeft")) || (p.contains(e.ownerDocument, e) ? e.getBoundingClientRect().left - Rt(e, {
              marginLeft: 0
            }, function() {
        ...
        un.propHooks = {
          _default: {
            get: function(e) {
              var t;
              return e.elem.nodeType !== 1 || e.elem[e.prop] != null && e.elem.style[e.prop] == null ? e.elem[e.prop] : (t = p.css(e.elem, e.prop, ""),
                !t || t === "auto" ? 0 : t)
            },
            set: function(e) {
        ...
        p.fx.step = {};
      var an, fn, ln = /^(?:toggle|show|hide)$/, cn = /queueHooks$/;
      p.Animation = p.extend(gn, {
        tweeners: {
          "*": [function(e, t) {
            var n = this.createTween(e, t);
            return K(n.elem, e, V.exec(t), n),
              n
          }
          ]
        },
        tweener: function(e, t) {
          ...
          for (; r < i; r++)
            n = e[r],
              gn.tweeners[n] = gn.tweeners[n] || [],
              gn.tweeners[n].unshift(t)
        },
        prefilters: [vn],
      ...
      var wn, En, Sn = p.expr.attrHandle, xn = /^(?:checked|selected)$/i, Tn = c.getSetAttribute, Nn = c.input;
      p.fn.extend({
        attr: function(e, t) {
        ...
        p.extend({
          attr: function(e, t, n) {
            ...
            return i && "get"in i && (r = i.get(e, t)) !== null ? r : (r = p.find.attr(e, t),
              r == null ? undefined : r)
          },
          attrHooks: {
            type: {
          ...
          removeAttr: function(e, t) {
            var n, r, i = 0, s = t && t.match(_);
            if (s && e.nodeType === 1)
              while (n = s[i++])
                r = p.propFix[n] || n,
                  p.expr.match.bool.test(n) ? Nn && Tn || !xn.test(n) ? e[r] = !1 : e[p.camelCase("default-" + n)] = e[r] = !1 : p.attr(e, n, ""),
                  e.removeAttribute(Tn ? n : r)
          }
        }),
        En = {
          set: function(e, t, n) {
            return t === !1 ? p.removeAttr(e, n) : Nn && Tn || !xn.test(n) ? e.setAttribute(!Tn && p.propFix[n] || n, n) : e[p.camelCase("default-" + n)] = e[n] = !0,
              n
          }
        },
      ...
      p.fn.extend({
        addClass: function(e) {
          ...
          if (typeof e == "string" && e) {
            ...
            while (n = this[a++]) {
              i = An(n),
                r = n.nodeType === 1 && (" " + i + " ").replace(Ln, " ");
              if (r) {
                o = 0;
                while (s = t[o++])
                  r.indexOf(" " + s + " ") < 0 && (r += s + " ");
                u = p.trim(r),
                i !== u && p.attr(n, "class", u)
              }
            }
          }
          return this
        ...
        ajax: function(t, n) {
          function T(t, n, r, i) {
            ...
            r && (E = Kn(c, S, r)),
              E = Qn(c, E, S, l);
            if (l)
              c.ifModified && (x = S.getResponseHeader("Last-Modified"),
              x && (p.lastModified[s] = x),
                x = S.getResponseHeader("etag"),
              x && (p.etag[s] = x)),
                t === 204 || c.type === "HEAD" ? T = "nocontent" : t === 304 ? T = "notmodified" : (T = E.state,
                  y = E.data,
                  b = E.error,
                  l = !b);
            else {
            ...
            a && d.trigger(l ? "ajaxSuccess" : "ajaxError", [S, c, l ? y : b]),
              m.fireWith(h, [S, T]),
            a && (d.trigger("ajaxComplete", [S, c]),
            --p.active || p.event.trigger("ajaxStop"))
          }
          typeof t == "object" && (n = t,
            t = undefined),
            n = n || {};
          var r, i, s, o, u, a, f, l, c = p.ajaxSetup({}, n), h = c.context || c, d = c.context && (h.nodeType || h.jquery) ? p(h) : p.event, v = p.Deferred(), m = p.Callbacks("once memory"), g = c.statusCode || {}, y = {}, b = {}, w = 0, E = "canceled", S = {
            readyState: 0,
          ...
          v.promise(S).complete = m.add,
            ...
            c.dataTypes = p.trim(c.dataType || "*").toLowerCase().match(_) || [""],
          c.crossDomain == null && (r = qn.exec(c.url.toLowerCase()),
            c.crossDomain = !(!r || r[1] === Xn[1] && r[2] === Xn[2] && (r[3] || (r[1] === "http:" ? "80" : "443")) === (Xn[3] || (Xn[1] === "http:" ? "80" : "443")))),
          c.data && c.processData && typeof c.data != "string" && (c.data = p.param(c.data, c.traditional)),
            $n(Rn, c, n, S);
          if (w === 2)
            return S;
          a = p.event && c.global,
          a && p.active++ === 0 && p.event.trigger("ajaxStart"),
            ...
            s = c.url,
          c.hasContent || (c.data && (s = c.url += (_n.test(s) ? "&" : "?") + c.data,
            delete c.data),
          c.cache === !1 && (c.url = Hn.test(s) ? s.replace(Hn, "$1_=" + Mn++) : s + (_n.test(s) ? "&" : "?") + "_=" + Mn++)),
          c.ifModified && (p.lastModified[s] && S.setRequestHeader("If-Modified-Since", p.lastModified[s]),
          p.etag[s] && S.setRequestHeader("If-None-Match", p.etag[s])),
          (c.data && c.hasContent && c.contentType !== !1 || n.contentType) && S.setRequestHeader("Content-Type", c.contentType),
            S.setRequestHeader("Accept", c.dataTypes[0] && c.accepts[c.dataTypes[0]] ? c.accepts[c.dataTypes[0]] + (c.dataTypes[0] !== "*" ? ", " + zn + "; q=0.01" : "") : c.accepts["*"]);
          for (i in c.headers)
            S.setRequestHeader(i, c.headers[i]);
        ...
        if (!t.crossDomain || c.cors) {
          ...
          return {
            send: function(r, i) {
              ...
              for (s in r)
                r[s] !== undefined && o.setRequestHeader(s, r[s] + "");
      ...
      p.ajaxSetup({
        ...
        p.ajaxPrefilter("json jsonp", function(t, n, r) {
          ...
          if (u || t.dataTypes[0] === "jsonp")
            return i = t.jsonpCallback = p.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
              u ? t[u] = t[u].replace(cr, "$1" + i) : t.jsonp !== !1 && (t.url += (_n.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
        ...
        p.parseHTML = function(e, t, n) {
          ...
          var i = x.exec(e)
            , s = !n && [];
          return i ? [t.createElement(i[1])] : (i = ft([e], t, s),
          s && s.length && p(s).remove(),
            p.merge([], i.childNodes))
        }
      ;
      var hr = p.fn.load;
      return p.fn.load = function(e, t, n) {
        if (typeof e != "string" && hr)
          return hr.apply(this, arguments);
        var r, i, s, o = this, u = e.indexOf(" ");
        return u > -1 && (r = p.trim(e.slice(u, e.length)),
          e = e.slice(0, u)),
          p.isFunction(t) ? (n = t,
        ...
        p.fn.extend({
          offset: function(e) {
            ...
            return t = s.documentElement,
              p.contains(t, i) ? (typeof i.getBoundingClientRect != "undefined" && (r = i.getBoundingClientRect()),
                n = pr(s),
                {
      ...
      typeof tp.define == "function" && tp.define.amd && tp.define("jquery", [], function() {
        return p
      }),
      "undefined" == typeof p.migrateMute && (p.migrateMute = !0),
        function(e, t, n) {
          ...
          s(e, "attrFn", u || {}, "jQuery.attrFn is deprecated"),
            e.attr = function(t, r, s, o) {
              var f = r.toLowerCase()
                , l = t && t.nodeType;
              return o && (a.length < 4 && i("jQuery.fn.attr( props, pass ) is deprecated"),
              t && !h.test(l) && (u ? r in u : e.isFunction(e.fn[r]))) ? e(t)[r](s) : ("type" === r && s !== n && c.test(t.nodeName) && t.parentNode && i("Can't change the 'type' of an input or button in IE 6/7/8"),
              !e.attrHooks[f] && p.test(f) && (e.attrHooks[f] = {
                get: function(t, r) {
                  var i, s = e.prop(t, r);
              ...
              d.test(f) && i("jQuery.fn.attr('" + f + "') might use property instead of attribute")),
                a.call(e, t, r, s))
            }
            ,
            e.attrHooks.value = {
              get: function(e, t) {
                ...
                return "button" === n ? f.apply(this, arguments) : ("input" !== n && "option" !== n && i("jQuery.fn.attr('value') no longer gets properties"),
                  t in e ? e.value : null)
              },
              set: function(e, t) {
                var n = (e.nodeName || "").toLowerCase();
          ...
          var v, m, g = e.fn.init, y = e.find, b = e.parseJSON, w = /^\s*</, E = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/, S = /\[(\s*[-\w]+\s*)([~|^$*]?=)\s*([-\w#]*?#[-\w#]*)\s*\]/g, x = /^([^<]*)(<[\w\W]+>)([^>]*)$/;
          e.fn.init = function(t, s, o) {
            var u, a;
            return t && "string" == typeof t && !e.isPlainObject(s) && (u = x.exec(e.trim(t))) && u[0] && (w.test(t) || i("$(html) HTML strings must start with '<' character"),
            u[3] && i("$(html) HTML text after last tag is ignored"),
            "#" === u[0].charAt(0) && (i("HTML string cannot start with a '#' character"),
              e.error("JQMIGRATE: Invalid selector string (XSS)")),
            s && s.context && s.context.nodeType && (s = s.context),
              e.parseHTML) ? g.call(this, e.parseHTML(u[2], s && s.ownerDocument || s || r, !0), s, o) : (a = g.apply(this, arguments),
              t && t.selector !== n ? (a.selector = t.selector,
                a.context = t.context) : (a.selector = "string" == typeof t ? t : "",
          ...
          var T;
          for (T in y)
            Object.prototype.hasOwnProperty.call(y, T) && (e.find[T] = y[T]);
          e.parseJSON = function(e) {
            return e ? b.apply(this, arguments) : (i("jQuery.parseJSON requires a valid JSON string"),
              null)
          }
            ,
            ...
            ,
          e.browser || (v = e.uaMatch(navigator.userAgent),
            m = {},
          v.browser && (m[v.browser] = !0,
            m.version = v.version),
            ...
            s(e.support, "boxModel", e.support.boxModel, "jQuery.support.boxModel is deprecated"),
            e.sub = function() {
              function t(e, n) {
          ...
          e.fn.data = function(t) {
            var r, s, o = this[0];
            return !o || "events" !== t || 1 !== arguments.length || (r = e.data(o, t),
              s = e._data(o, t),
            r !== n && r !== s || s === n) ? C.apply(this, arguments) : (i("Use of jQuery.fn.data('events') is deprecated"),
              s)
          }
          ;
          ...
          e.clean || (e.clean = function(t, n, s, o) {
              ...
              var u, a, f, l, c = [];
              if (e.merge(c, e.buildFragment(t, n).childNodes),
                s)
                for (f = function(e) {
                  return !e.type || k.test(e.type) ? o ? o.push(e.parentNode ? e.parentNode.removeChild(e) : e) : s.appendChild(e) : void 0
                       ...
                       ,
                       u = 0; null != (a = c[u]); u++)
                  e.nodeName(a, "script") && f(a) || (s.appendChild(a),
                  "undefined" != typeof a.getElementsByTagName && (l = e.grep(e.merge([], a.getElementsByTagName("script")), f),
          ...
          e.event.dispatch && s(e.event, "handle", e.event.dispatch, "jQuery.event.handle is undocumented and deprecated"),
            e.event.add = function(e, t, n, s, o) {
              e !== r && B.test(t) && i("AJAX events should be attached to document: " + t),
            ...
            e.each(["load", "unload", "error"], function(t, n) {
              e.fn[n] = function() {
                ...
                return "load" === n && "string" == typeof e[0] ? P.apply(this, e) : (i("jQuery.fn." + n + "() is deprecated"),
                  e.splice(0, 0, n),
            ...
            e.fn.live = function(t, n, r) {
              return i("jQuery.fn.live() is deprecated"),
                _ ? _.apply(this, arguments) : (e(this.context).on(t, this.selector, n, r),
                  this)
            }
            ,
            e.fn.die = function(t, n) {
              return i("jQuery.fn.die() is deprecated"),
                D ? D.apply(this, arguments) : (e(this.context).off(t, this.selector || "**", n),
                  this)
            }
            ,
            e.event.trigger = function(e, t, n, s) {
              return n || B.test(e) || i("Global events are undocumented and deprecated"),
            ...
            e.each(H.split("|"), function(t, n) {
              e.event.special[n] = {
                ...
                teardown: function() {
                  return this !== r && e.event.remove(r, n + "." + e._data(this, n)),
                    !1
                }
              }
            }),
          ...
          if (e.fn.andSelf = function() {
            ...
            e.Callbacks) {
            var R = e.Deferred
              , U = [["resolve", "done", e.Callbacks("once memory"), e.Callbacks("once memory"), "resolved"], ["reject", "fail", e.Callbacks("once memory"), e.Callbacks("once memory"), "rejected"], ["notify", "progress", e.Callbacks("memory"), e.Callbacks("memory")]];
        ...
        function(e) {
          var t, n, i = 1, s, o = this, u = !1, a = "postMessage", f = "addEventListener", l, c = o[a] && !e.browser.opera;
          e[a] = function(t, n, r) {
            if (!n)
              return;
            t = typeof t == "string" ? t : e.param(t),
              r = r || parent,
              c ? r[a](t, n.replace(/([^:]+:\/\/[^\/]+).*/, "$1")) : n && (r.location = n.replace(/#.*$/, "") + "#" + +(new Date) + i++ + "&" + t)
          }
            ,
            e.receiveMessage = l = function(i, a, h) {
              c ? (i && (s && l(),
                  s = function(t) {
                    if (typeof a == "string" && t.origin !== a || e.isFunction(a) && a(t.origin) === u)
                      return u;
                    i(t)
                  }
              ),
                o[f] ? o[i ? f : "removeEventListener"]("message", s, u) : o[i ? "attachEvent" : "detachEvent"]("onmessage", s)) : (t && clearInterval(t),
                t = null,
              i && (h = typeof a == "number" ? a : typeof h == "number" ? h : 100,
        ...
        function(e) {
          e.deparam = function(t, n) {
            ...
            return e.each(t.replace(/\+/g, " ").split("&"), function(t, s) {
              ...
              var f, l = r, c = 0, h = u.split("]["), p = h.length - 1;
              /\[/.test(h[0]) && /\]$/.test(h[p]) ? (h[p] = h[p].replace(/\]$/, ""),
              ...
              if (o.length === 2) {
                ...
                if (p)
                  for (; c <= p; c++)
                    u = h[c] === "" ? l.length : h[c],
                      l = l[u] = c < p ? l[u] || (h[c + 1] && isNaN(h[c + 1]) ? {} : []) : f;
                else
                  e.isArray(r[u]) ? r[u].push(f) : r[u] !== undefined ? r[u] = [r[u], f] : r[u] = f
              } else
                u && (r[u] = n ? undefined : "")
            }),
              r
          ...
          n.c = {},
            ...
            n.o = function() {
              ...
              this.o = null,
                ...
                this.run = function() {
                  ...
                  return this.scale = (e.devicePixelRatio || 1) / (this.c.webkitBackingStorePixelRatio || this.c.mozBackingStorePixelRatio || this.c.msBackingStorePixelRatio || this.c.oBackingStorePixelRatio || this.c.backingStorePixelRatio || 1),
                ...
                this._touch = function(e) {
                  var t = function(e) {
                    ...
                    if (i.cH && i.cH(t) === !1)
                      return;
                    i.change(i._validate(t)),
                      i._draw()
                  };
                  return this.t = n.c.t(e),
                    t(e),
                ...
                this._mouse = function(e) {
                  ...
                  return t(e),
                    n.c.d.bind("mousemove.k", t).bind("keyup.k", function(e) {
                      if (e.keyCode === 27) {
                ...
                this._listen = function() {
                  return this.o.readOnly ? this.$.attr("readonly", "readonly") : (this.$c.bind("mousedown", function(e) {
                    ...
                    this.listen()),
                  this.relative && t(e).resize(function() {
                    i._carve().init(),
                      i._draw()
                  }),
                    this
            ...
            n.Dial = function() {
              n.o.call(this),
                ...
                this.xy2val = function(e, t) {
                  var n, r;
                  return n = Math.atan2(e - (this.x + this.w2), -(t - this.y - this.w2)) - this.angleOffset,
                    this.angleArc != this.PI2 && n < 0 && n > -0.5 ? n = 0 : n < 0 && (n += this.PI2),
                    r = ~~(.5 + n * (this.o.max - this.o.min) / this.angleArc) + this.o.min,
                ...
                this.listen = function() {
                  ...
                  this.$.bind("keydown", function(r) {
                    ...
                    isNaN(o) ? u && (e.clearTimeout(u),
                      u = null,
                      a = 1,
                      n.val(n.$.val())) : n.$.val() > n.o.max && n.$.val(n.o.max) || n.$.val() < n.o.min && n.$.val(n.o.min)
                  }),
                ...
                this.draw = function() {
                  ...
                  this.o.cursor && (n = r - this.cursorExt) && (r += this.cursorExt),
                    ...
                    e.arc(this.xy, this.xy, this.radius, this.endAngle - 1e-5, this.startAngle + 1e-5, !0),
                    e.stroke(),
                  this.o.displayPrevious && (s = this.startAngle + this.angle(this.v),
                    i = this.startAngle,
          ...
          var t = /\+/g
            , s = e.cookie = function(t, o, u) {
              if (o !== undefined) {
                ...
                return o = s.json ? JSON.stringify(o) : String(o),
                  r.cookie = [s.raw ? t : encodeURIComponent(t), "=", s.raw ? o : encodeURIComponent(o), u.expires ? "; expires=" + u.expires.toUTCString() : "", u.path ? "; path=" + u.path : "", u.domain ? "; domain=" + u.domain : "", u.secure ? "; secure" : "", u.samesite ? "; samesite=" + u.samesite : ""].join("")
              }
              var l = t ? undefined : {}
        ...
        function(t) {
          function i(n) {
            var r = arguments.length, i = e[n], s = arguments, o = s[1], u, a, f;
            if (r < 2)
            ...
            if (r != 2) {
              ...
              for (var l = 2; l < r - 1; l++) {
                a = a[s[l]];
                if (a === undefined)
                  throw new ReferenceError([].slice.call(s, 1, l + 1).join(".") + " is not defined in this storage")
              }
              if (t.isArray(s[l])) {
                f = a,
                  a = {};
          ...
          function s(n) {
            var r = arguments.length, i = e[n], s = arguments, o = s[1], u = s[2], a, f = {}, l;
            ...
            if (r == 3)
              return typeof u == "object" ? i.setItem(o, JSON.stringify(u)) : i.setItem(o, u),
                u;
            try {
              l = i.getItem(o),
              l != null && (f = JSON.parse(l))
            } catch (h) {}
            l = f;
            for (var c = 2; c < r - 2; c++) {
              a = s[c];
              if (!l[a] || !t.isPlainObject(l[a]))
                l[a] = {};
              l = l[a]
            }
            return l[s[c]] = s[c + 1],
              i.setItem(o, JSON.stringify(f)),
              f
          }
          function o(n) {
            var r = arguments.length, i = e[n], s = arguments, o = s[1], u, a;
            if (r < 2)
              throw new Error("Minimum 2 arguments must be given");
            if (t.isArray(o)) {
              for (var f in o)
            ...
            for (var f = 2; f < r - 1; f++) {
              a = a[s[f]];
              if (a === undefined)
                throw new ReferenceError([].slice.call(s, 1, f).join(".") + " is not defined in this storage")
            }
            if (t.isArray(s[f]))
              for (var c in s[f])
                delete a[s[f][c]];
              ...
              delete a[s[f]];
            return i.setItem(o, JSON.stringify(u)),
              !0
          }
          function u(e, n) {
            var r = l(e);
            for (var i in r)
              o(e, r[i]);
            if (n)
              for (var i in t.namespaceStorages)
                c(i)
          }
          function a(n) {
            ...
            try {
              ...
              for (var f in c)
                if (!(t.isPlainObject(c[f]) && t.isEmptyObject(c[f]) || t.isArray(c[f]) && !c[f].length || !c[f]))
                  return !1;
              return !0
            } catch (h) {
              return !0
          ...
          function l(n) {
            ...
            if (f._cookie)
              for (var l in t.cookie())
                l != "" && a.push(l.replace(f._prefix, ""));
            else
              for (var c in f)
                a.push(c);
            return a
          ...
          function c(n) {
            ...
            d ? (e.localStorage.getItem(n) || e.localStorage.setItem(n, "{}"),
            e.sessionStorage.getItem(n) || e.sessionStorage.setItem(n, "{}")) : (e.localCookieStorage.getItem(n) || e.localCookieStorage.setItem(n, "{}"),
            ...
            return t.cookie && (e.cookieStorage.getItem(n) || e.cookieStorage.setItem(n, "{}"),
              r.cookieStorage = t.extend({}, t.cookieStorage, {
                _ns: n
              })),
          ...
          var n = "ls_"
            ...
            removeAll: function(e) {
              return this._ns ? (s(this._type, this._ns, {}),
                !0) : u(this._type, e)
            },
            isEmpty: function() {
          ...
          if (t.cookie) {
            ...
            var m = {
              ...
              clear: function() {
                for (var e in t.cookie())
                  e != "" && (!this._prefix && e.indexOf(n) === -1 && e.indexOf(r) === -1 || this._prefix && e.indexOf(this._prefix) === 0) && t.removeCookie(e)
              },
            ...
            d || (e.localCookieStorage = t.extend({}, m, {
              ...
              t.cookieStorage = t.extend({}, v, {
                _type: "cookieStorage",
                setExpires: function(e) {
                  return p.cookieStorage.setExpires(e),
                    this
                },
                setPath: function(e) {
                  return p.cookieStorage.setPath(e),
                    this
                },
                setDomain: function(e) {
                  return p.cookieStorage.setDomain(e),
                    this
                },
                setConf: function(e) {
                  return p.cookieStorage.setConf(e),
                    this
                },
                setDefaultConf: function() {
                  return p.cookieStorage.setDefaultConf(),
                    this
                }
              })
          }
  ...
  tp.define("jq", function() {}),
  tp.define("main", ["jq", "util", "api", "fingerprint", "user", "sha1", "activetimer", "scrollDepth", "doubleClickForPublisher", "offer", "viewportExit", "idle", "log", "experience", "pianoId", "pianoEsp", "applePayIntegrationService", "cxense", "gaService", "logging", "captchaV3"], function(e, t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b, w) {
    function S() {
      return t.getCurrentDomainFromCookie(E.__private__.VISIT_ID_COOKIE)
    }
    function x(e, t) {
      var n = E.__private__.collectedAds;
      E.__private__.collectedAds = {};
      var r = {};
      for (var i in n)
        if (n.hasOwnProperty(i)) {
          r[i] = r[i] || [];
          for (var s in n[i])
            n[i].hasOwnProperty(s) && r[i].push(n[i][s])
        }
      E.trackAds(r, e, t)
    }
    function T() {
      if (E.__private__.isCxenseActivated())
        return E.__private__.generateCxCompatibleRandomId();
    ...
    function N() {
      var e;
      try {
        e = JSON.parse(t.__protected__.getCookie(E.__private__.VISIT_ID_COOKIE))
      } catch (n) {
        e = {}
      }
      return e
    ...
    function C(e) {
      var t = {
        path: "/",
        expires: 1,
        domain: E.__private__.visitContainer.currentDomain
      };
      return e && (t.domain = e),
        t
    }
    function k(e, n) {
      e.domain = n.domain,
        ...
        t.__protected__.setCookie(E.__private__.VISIT_ID_COOKIE, JSON.stringify(e), n)
    }
    function L(e) {
      var n = E.__private__.getVisitCookieOptions();
      !e.domain && !E.__private__.visitContainer.currentDomain ? t.waitCall("domainIsReceived", function(t) {
        E.__private__.setVisitCurrentDomain(t),
          n.domain = t,
          E.__private__.saveVisitCookie(e, n)
      }) : E.__private__.saveVisitCookie(e, n)
    }
    function A(e) {
    ...
    function O() {
      if (t.__protected__.cameFromFbSubscriptions())
        return !1;
      if (!E.__private__.visitContainer.currentDomain)
        return !1;
      var e = t.getReferrer();
      if (E.__private__.lastReferrer && E.__private__.lastReferrer === e)
        return !1;
      var n = t.getHostname(e)
        , r = (new RegExp(E.__private__.visitContainer.currentDomain.replace(/\./g, "\\.").replace(/^\\./, "\\.?") + "$")).test(n);
      return Boolean(n) && !r
    }
    function M() {
      var e = E.__private__.loadLastVisit()
        , t = !e || !e.id || !e.time;
      if (t || E.__private__.isTimeExpired(e) || E.__private__.hasExternalReferrer())
        e.id = "v-" + E.__private__.generatePageViewId();
      E.__private__.saveLastVisit(e),
        E.__private__.visitContainer.visit = e
    }
    function _(n, i, s) {
      var o = "manual";
      ...
      tp.customPageUrl && (n.custom_page_url = t.prepareUrlParameter(tp.customPageUrl)),
        typeof s != "undefined" ? Object.prototype.toString.call(s) !== "[object Array]" && Object.prototype.toString.call(s) !== "[object String]" ? (t.log("Tags must be an array or a comma-separated string, ignoring supplied tags"),
          s = "") : Object.prototype.toString.call(s) === "[object Array]" && (s = s.join(",")) : s = "",
        E.__private__.pageView.track(),
        n.page_session_id = E.__private__.pageView.pageSessionId,
        n.track_count = E.__private__.pageView.trackCount,
        E.__private__.setPageViewId(n);
      var a;
      ...
      var f = tp.contentSection || E.__private__.getMetaTagContent("section");
      f && (n.content_section = f);
      var l = tp.contentAuthor || E.__private__.getMetaTagContent("author");
      l && (n.content_author = l);
      var c = tp.contentId || E.__private__.getMetaTagContent("id");
      c && (n.content_id = c);
      var h = t.__protected__.getCookie("sailthru_hid");
      h && (n.sailthru_hid = h);
      var p;
      E.__private__.lastReferrer && E.__private__.lastReferrer === t.getReferrer() ? p = "" : (p = t.getReferrer(),
        E.__private__.lastReferrer = p),
      ...
      if (n.adblocker === t.ADBLOCKER_STATUS.ENABLED_AFTER_DISABLED || n.adblocker === t.ADBLOCKER_STATUS.ENABLED)
      ...
      n.timezone_offset = t.getBrowserTimezoneOffset(),
        n.submit_type = o;
      var d = E.__protected__.fetchVisitId();
      return n.visit_id = d,
        n.new_visit = E.__private__.checkIfNewVisitAndUpdateLastTrackedVisitId(d),
        ...
        E.__private__.buildPageCustomParams(n),
        n
    }
    function D() {
      var n = {
      ...
      i.total < i.active && (i.total = i.active),
        ...
        E.__private__.setPageViewId(n),
        n.visit_id = E.__protected__.fetchVisitId(),
        E.__private__.markVisitToCheckForRefresh();
      var s = {}
        , f = 200
        , c = a.getAds(f);
      return c.length && (s.dfp = c),
      e.isEmptyObject(s) || (n.ads = JSON.stringify(s)),
        n
    }
    function P(t) {
      var n = {};
      return tp.customParams && (n = e.extend(!0, {}, tp.customParams)),
      e.isEmptyObject(n) || (t.custom_params = JSON.stringify(n)),
        t
    }
    function H() {
      return E.__private__.pageView.id
    }
    function B(e) {
      var t = E.__private__.visitContainer.lastTrackedVisitId !== e;
      return E.__private__.visitContainer.lastTrackedVisitId = e,
        t
    }
    function j() {
      E.__private__.visitContainer.checkForRefresh = !0
    }
    function F() {
      return E.__private__.visitContainer.checkForRefresh && (E.__private__.refreshVisit(),
        E.__private__.visitContainer.checkForRefresh = !1),
        E.__private__.visitContainer.visit.id
    }
    function I(e) {
    ...
    function q(e) {
      E.__private__.visitContainer.currentDomain = e
    }
    function R() {
      var t = E.__private__.getVisitCookieOptions();
      e.removeCookie(E.__private__.VISIT_ID_COOKIE, t)
    }
    function U() {
    ...
    function z(e, r, i, s) {
      ...
      if (!E.__private__.currentEnvironmentSupportsPageTrack())
        return !1;
    ...
    function W() {
      E.__private__.unloadRegistered && E.__private__.pageView.trackCount > 0 && (E.trackPageUnload(),
        E.resetTimer())
    }
    function X(e) {
      if (!E.__private__.currentEnvironmentSupportsPageTrack())
        return;
      try {
        var n = E.__private__.buildPageUnloadParams();
        l.isInitialized() && l.resetSumOfCodesDirectionToDefault(),
          h.__private__.logBeaconRequest(tp.getTrackingEndpoint() + "/api/v3/page/unload", n),
          E.unregisterTrackUnload()
      } catch (r) {
        t.error("main: error on tracking page unload event: ", r)
      }
    }
    function V() {
      E.__private__.unloadTriggered || (E.__private__.unloadTriggered = !0,
        E.trackPageUnload(!0))
    }
    function $() {
      E.__private__.unloadRegistered = !0
    }
    function J() {
      return E.__private__.unloadRegistered
    }
    function K() {
      E.__private__.unloadRegistered = !1
    }
    function Q() {
      E.__private__.unloadRegistered && E.__private__.unloadAction(),
        E.__private__.trackCollectedAds(!0, E.__private__.BEACON_REQUEST),
    ...
    function Z(e) {
      e && (e.pageview_id = E.fetchPageViewId())
    }
    function et(e, n) {
      if (!E.__private__.currentEnvironmentSupportsPageTrack())
        return !1;
      try {
        E.__protected__.trackPageUnloadIfNecessary();
        var r = E.buildPageTrackParams({}, e, n);
        E.__private__.track("/page/track", r),
          E.registerTrackUnload()
      } catch (i) {
    ...
    function nt(e, t, n) {
      E.__private__.collectedAds[e] || (E.__private__.collectedAds[e] = {}),
        E.__private__.collectedAds[e][t] = n,
        E.__private__.debouncedTrackAds()
    }
    function rt() {
      var e = t.getQueryParamByName(E.__private__.VOUCHER_QUERY);
    ...
    function it() {
      ...
      if (!e || i.getProvider().name !== "pianoId")
        return;
      t.waitCall("offerCreate", function() {
    ...
    function ot() {
      return E.__private__.externalResourcesDef ? E.__private__.externalResourcesDef.promise() : (E.__private__.externalResourcesDef = e.Deferred(),
      t.__protected__.getLocalStorageItem(E.__private__.EXTERNAL_RESOURCES) !== null && E.__private__.externalResourcesDef.resolve({
        has_active_apple_pay_card: t.__protected__.getLocalStorageItem(E.__private__.EXTERNAL_RESOURCES)
      }),
        tp.applePayMerchantId ? (m.__protected__.applePayCanMakePaymentsWithActiveCard().then(function(e) {
          E.__private__.externalResourcesDef.resolve({
            has_active_apple_pay_card: e
          }),
            t.__protected__.setLocalStorageItem(E.__private__.EXTERNAL_RESOURCES, e, E.__private__.EXTERNAL_RESOURCES_TTL)
        }),
          E.__private__.externalResourcesDef.promise()) : (E.__private__.externalResourcesDef.resolve({
          has_active_apple_pay_card: null
        }),
          E.__private__.externalResourcesDef.promise()))
    }
    function ut() {
    ...
    function ft() {
      ...
      tp.isMockMode || (a.initialize(),
        o.initialize(),
        u.initialize()),
        c.initialize(),
        m.initialize(),
        E.__private__.checkVoucher(),
        E.__private__.checkVerificationCode(),
        d.__protected__.checkAndShowEmailIsNotConfirmed(),
        E.__private__.initPianoEsp(),
        E.__private__.checkThreeDSRedirect(),
        i.refreshAccessToken(),
        E.__protected__.externalResourcesDelay();
      var e = i.getProvider();
      e.__private__ && t.isFunction(e.__private__.extendUserToken) && e.__private__.extendUserToken(),
        w.addCaptchaV3()
    }
    var E = {
      __private__: {},
    ...
    return E.name = "main",
      E.pageTrack = et,
      E.trackPage = E.pageTrack,
      E.buildPageTrackParams = _,
      E.fetchPageViewId = H,
      E.trackPageUnload = X,
      E.registerTrackUnload = $,
      E.isRegisteredTrackUnload = J,
      E.unregisterTrackUnload = K,
      E.resetTimer = G,
      E.resetAds = Y,
      E.trackAds = tt,
      E.trackAd = nt,
      E.init = ft,
      E.__protected__.fetchVisitId = F,
      E.__protected__.trackPageUnloadIfNecessary = W,
      E.__protected__.externalResourcesDelay = ot,
      E.__private__.BEACON_REQUEST = "beacon_request",
      E.__private__.saveVisitCookie = k,
      E.__private__.trackCollectedAds = x,
      E.__private__.getCurrentDomain = S,
      E.__private__.generatePageViewId = T,
      E.__private__.loadLastVisit = N,
      E.__private__.getVisitCookieOptions = C,
      E.__private__.saveLastVisit = L,
      E.__private__.isTimeExpired = A,
      E.__private__.hasExternalReferrer = O,
      E.__private__.refreshVisit = M,
      E.__private__.setPageViewId = Z,
      E.__private__.buildPageUnloadParams = D,
      E.__private__.buildPageCustomParams = P,
      E.__private__.checkIfNewVisitAndUpdateLastTrackedVisitId = B,
      E.__private__.markVisitToCheckForRefresh = j,
      E.__private__.getMetaTagContent = I,
      E.__private__.setVisitCurrentDomain = q,
      E.__private__.invalidateLastVisit = R,
      E.__private__.currentEnvironmentSupportsPageTrack = U,
      E.__private__.track = z,
      E.__private__.unloadAction = V,
      E.__private__.unloadHandler = Q,
      E.__private__.checkVoucher = rt,
      E.__private__.checkVerificationCode = it,
      E.__private__.initPianoEsp = v.__protected__.init,
      E.__private__.checkThreeDSRedirect = st,
      E.__private__.isCxenseActivated = ut,
      E.__private__.generateCxCompatibleRandomId = at,
      E.__private__.VOUCHER_QUERY = "voucher_code",
      E.__private__.VERIFICATION_CODE_QUERY = "verification_code",
      E.__private__.VISIT_ID_COOKIE = "__pvi",
      E.__private__.unloadRegistered = !1,
      E.__private__.unloadTriggered = !1,
      E.__private__.collectedAds = {},
      E.__private__.debouncedTrackAds = t.debounce(E.__private__.trackCollectedAds, 3e3),
      E.__private__.lastReferrer = null,
      E.__private__.pageView = {
        id: E.__private__.generatePageViewId(),
        pageSessionId: "s-" + E.__private__.generatePageViewId(),
        trackCount: 0,
        tracked: !1,
        track: function() {
          this.tracked ? this.id = E.__private__.generatePageViewId() : this.tracked = !0,
            this.trackCount++
        }
      },
      E.__private__.visitContainer = {
        currentDomain: E.__private__.getCurrentDomain(),
        lastTrackedVisitId: E.__private__.loadLastVisit().id,
        visit: {},
        checkForRefresh: !1
      },
      E.__private__.refreshVisit(),
      E.__private__.EXTERNAL_RESOURCES = "exrs",
      E.__private__.EXTERNAL_RESOURCES_TTL = 7200,
      E.__private__.externalResourcesDef = null,
      e(window).on("pagehide", E.__private__.unloadHandler),
      E
  }),
  tp.define("api", ["jq", "util"], function(e, t) {
    var n = t.findCookieByName(/__TP_*/), r = function() {
      var e = function() {
        return "mock"
      }
        , t = function() {
    ...
    typeof window._tpm != "undefined" && typeof window._tpm.paywallID != "undefined" && (paywallID = window._tpm.paywallID,
    ...
    var o = t.__protected__.getCookie("__tac")
      ...
      var i = t.getAffiliateToken(tp.affiliateTokenName);
      i && (e.affiliateToken = i)
    }
      , f = function(e) {
      var t = "/access/list"
        , n = "/access/check"
      ...
      function b(e, t) {
        ...
        for (var r = 1; r < arguments.length; r++) {
          ...
          for (var o = 0, u = s.length; o < u; o++) {
            ...
            f !== undefined && f.enumerable && (n[a] = i[a])
          }
        }
        return n
      }
      ...
      var h;
      typeof s != "undefined" ? h = s : h = u(),
        h += n;
      if (typeof r == "undefined" || !r)
        r = {};
      var p = t.getTbcCookie();
      p && (r.tbc = p),
        a(r);
      var d;
      typeof i == "undefined" ? d = function(e) {
      ...
      ;
      var v = f(n);
      if (v !== null && !tp.user.getProvider().isUserValid()) {
        d(v);
        return
      }
      l(n);
      ...
      h += "?" + m,
        g.url = h,
      o && (g.async = !1),
        e.ajax(g).done(d).fail(function() {
          var e = {
            code: 503,
            message: "Error: Received error when requesting API response from URL: " + h
          };
          t.log(e.message),
            d(e)
        })
  ...
  tp.define("logging", ["log", "api"], function(e, t) {
    var n = {
      completeInit: 0,
      track: 0,
      expExec: 0,
      ...
      , r = "/internal/anon/telemetry/ux/init/time/log"
      , i = function(e) {
      if (n[e] !== 0)
        return;
      n[e] = Math.round(performance.now() - window.pnInitPerformance)
    }
      , s = function() {
      return t.getEndpoint() + r
    }
      , o = function(t) {
      ...
      var r = t || "js_c";
      const i = {
        completeInit: n.completeInit,
        expExec: n.expExec,
        idShow: n.idShow,
        myAccountShow: n.myAccountShow,
        offerShow: n.offerShow,
        templateShow: n.templateShow,
        tpAccShow: n.tpAccShow,
        track: n.track,
        aid: tp.aid,
        type: r
      };
      e.logBeaconRequest(s(), i)
    };
  ...
  tp.define("offer", ["jq", "util", "postmessage", "user", "require-css/css!styles/offer", "containerUtils", "eventUtils", "viewportExit", "gaService", "logging", "template"], function(e, t, n, r, i, s, o, u, a, f, l) {
    function A(e, t) {
      e.config.cacheableTemplateContextPromise.then(function(r) {
        var i = {
          iframeParams: e.iframeParams,
          userContext: r
        };
        n.send("userDataContextLoaded", i, t.params.iframeId)
      })
    }
    ...
    function M(e, t, n, i) {
      t.source = m,
        ...
        N.fireCallbacks("loginSuccess", t, n, i);
      if (!E) {
        var s = {
    ...
    function _(t, n) {
      ...
      n.customVariables && (S[t.iframeId] = JSON.stringify(n.customVariables));
      var i = n.contentCreated;
      return i && (t.contentCreated = i),
      n && n.main && (t.pageViewId = n.main.fetchPageViewId(),
    ...
    function I(e, i) {
      ...
      var u = t.getTbcCookie();
      u && u.length > 0 && (o.tbc = u),
        e.generateIframeIdFn ? o.iframeId = e.generateIframeIdFn(e, x) : o.iframeId = "offer-" + p++ + "-" + t.randomString(),
        ...
        o.parentOuterHeight = window.outerHeight,
      ...
      !a.getGAAccount() || (o.gaAccount = a.getGAAccount()),
        _(o, tp);
      var l = N.hasCallback("loginRequired");
      if (tp.janrain.isConfigured() && (typeof e.loginRequired == "undefined" || !e.loginRequired)) {
        ...
        tp.gigya.registerCallback("onHide", function(e) {
          s.activateContainers(h),
            n.send("gigyaHide", e, b)
        }),
          X(),
          e.loginRequired = function(e) {
            return w = e.allowReturnToStartState,
              g = !1,
        ...
        tp.pianoIdLite.isConfigured() && (o.pianoIdUrl = tp.pianoId.getIframeUrl());
      o.userProvider = r.getProvider().getName(),
        ...
        N.registerCallback(e, o.iframeId),
        o.hasLoginRequiredCallback = N.hasIframeCallback("loginRequired", o.iframeId) || l,
        q(o);
      var m = e.iframeUrl ? e.iframeUrl : o.isCheckout ? k() : C()
        , E = e.postMessageUrl ? e.postMessageUrl : C()
        , S = R(o, e)
        , A = s.createContainer({
        url: m,
        config: e,
        ...
        close: function() {
          N.fireCallbacks("close", {
            state: d
          }, o.iframeId, !0)
        }
      })
        , O = m.indexOf("/offer/") ? "offerShow" : "templateShow";
      return f.setTime(O),
        T = m.indexOf("/template/") && o.offerId === s.fakeOfferId ? o : T,
        A.statParams = S,
        A.browserId = e.browserId,
        c.push(A),
        A
    }
    function q(e) {
    ...
    function R(t, n) {
      var r = {};
      if (n.trackStatsOnShow || n.deferredContextLoading)
        return r;
      ...
      return e.each(i, function(e, n) {
        ...
        e.each(t, function(e, n) {
          e.indexOf("tpcc_") === 0 && (r[e] = n,
            delete t[e])
        }),
        r
    }
    function U(e) {
      var t = W(e.iframeParams, e.statParams);
    ...
    function X() {
      E || (tp.gigya.registerCallback("userChanged", function(e) {
        if (e && e.user_token) {
          var t = {
            ...
            user: e.user,
            allowReturnToStartState: w,
            termId: y
          };
          if (b) {
            var r = s.getIframe(b);
            r ? (n.send("externalLoginSuccess", t, b),
              delete t.termId,
              rt(t, b)) : rt(t)
          } else
            rt(t)
    ...
    function V() {
      E || (tp.janrain.registerCallback("userChanged", function(t) {
        if (t && t.user_token) {
          var r = {
          ...
          if (b) {
            var i = s.getIframe(b);
            i ? (n.send("externalLoginSuccess", r, b),
              delete r.termId,
              rt(r, b)) : rt(r)
          } else
            rt(r)
    ...
    function it(t, n) {
      ...
      n.term && (r.term = {},
        r.term = W(r.term, n.term)),
      n.startScreen && (r.startScreen = n.startScreen),
      n.isRedemption && (r.isRedemption = n.isRedemption,
        r.voucherCode = n.redemption && n.redemption.form && n.redemption.form.redeemCode,
        r.termId = null),
      ...
      n.isSiteLicensing && (r.isSiteLicensing = n.isSiteLicensing),
        r.displayMode = "modal",
        r
    }
    function ot() {
      return r.getProvider().getName() === "publisher_user_ref"
    }
    var c = []
      , h = {}
      , p = 0
      ...
      , x = new Map
      , T = {}
      , N = o.createEventManager(["complete", "cancel", "close", "error", "loginRequired", "loginSuccess", "loaded", "customEvent", "startCheckout", "resize", "onMeterExpired", "onMeterActive", "onAccessGranted", "onShowOffer", "pianoIdEvent", "parentSize"])
      , C = function() {
      ...
      switch (i.event) {
        ...
        case "fullRedirectThreeDS":
          ...
          break;
        case "resize":
          i.params.iframeId === i.sender && (s.resizeIframe(f, i.params),
          f.config.displayMode === "modal" && (i.params.closeButtonType === "boilerplate" && s.hideCloseButton(f.container),
            s.centerIt(f.container)),
            n.send("afterResize", {}, f.iframeId)),
            N.fireCallbacks(i.event, i.params, i.sender, l);
          break;
        case "startCheckout":
          i.params.width = null;
          if (i.displayMode === "inline") {
            i.params.closeOnLogout = !0;
            var c = W(i.params, f.statParams);
            c.browserId = f.browserId,
              c.isOpenedFromInlineCheckout = !0,
              et(c, i.sender)
          }
          i.params.iframeId === i.sender && N.fireCallbacks(i.event, i.params, i.sender, l);
          break;
        case "loaded":
          if (i.params.iframeId === i.sender) {
            n.send("setupCustomVariables", S[i.params.iframeId], i.params.iframeId),
              n.send("setupEVTFields", f.config.externalVerificationFields, i.params.iframeId),
            f.config.deferredContextLoading && A(f, i);
            if (f.waitFinishProcesses) {
              s.__protected__.closeAndRemoveIframe(f);
              return
            }
            r.getProvider().name === "pianoId" && tp.pianoId.__protected__.executePostMessagesBatch(),
            f.config.displayMode === "modal" && (s.resizeIframe(f, i.params),
            f.config.isPreload || s.checkBackdropAndContainer(f, !0)),
            f.config.displayMode === "popup" && s.resizeIframe(f, i.params),
            !f.config.isPreload && !f.config.trackStatsOnShow && U(f),
              z(f),
              N.fireCallbacks(i.event, i.params, i.sender, l),
            f.config.displayMode === "inline" && (f.containerReady ? s.resizeIframe(f, i.params) : s.operationWithContainer(f.iframeParams.containerSelector, function(t) {
        ...
        case "downForMaintenance":
          ...
          f.config.displayMode === "modal" && (f.config.isPreload || s.checkBackdropAndContainer(f));
          break;
        case "purge":
          o || (i && i.params && i.params.alreadyPurchased && (d = "alreadyHasAccess"),
          i && i.params && i.params.completePayment && (d = "checkoutCompleted"),
        ...
        case "close":
          o || (i && i.params && i.params.alreadyPurchased && (d = "alreadyHasAccess"),
          i && i.params && i.params.completePayment && (d = "checkoutCompleted"),
          t.hasQueryParamByName("voucher_code") && (d = "voucherRedemptionCompleted"),
        ...
        case "closeAndRefresh":
          ...
          break;
        case "selectTerm":
          i && i.params && i.params.alreadyPurchased ? d = "alreadyHasAccess" : d = "close";
          break;
        case "submitPayment":
          N.fireCallbacks(i.event, W(i.params, {
            offerId: f.iframeParams.offerId
          }), i.sender, l);
          break;
        case "complete":
          if (typeof i.params.token_list != "undefined") {
            var p = r.getProvider().getToken();
          ...
          N.fireCallbacks(i.event, v, i.sender, l),
            d = "checkoutCompleted";
          break;
        ...
        case "loginRequired":
          g = !0,
            N.fireCallbacks(i.event, it(f, i.params), i.sender, l);
          break;
        case "logout":
          O(i.event, i.params, i.sender, f.config.parent, l);
          break;
        case "loginSuccess":
          M(i.event, i.params, i.sender, l);
          break;
        case "inputFocus":
        ...
        case "inputBlur":
          ...
          break;
        case "getLocation":
          i.params && i.params.resultCallbackId && (i.params.result = window.location.href,
        ...
        case "parentSize":
          ...
          n.send("parentSize", m, i.sender);
          break;
        case "gigyaPasswordlessLogin":
          i.params.iframeId === i.sender && (b = i.params.iframeId,
            tp.gigya.loginByPasswordless(i.params));
          break;
        case "emitGAEvent":
      ...
      , F = function(n) {
      d = "close";
      if (typeof n.displayMode == "undefined")
        n.displayMode = "modal";
      ...
      N.hasCallback(t) && N.fireCallbacks(t, e, null, !0)
    }
      , Q = function(e) {
        ...
        t.waitCall("refreshUserToken", function() {
          t.waitCall("refreshAccessTokenList", function() {
            t.waitCall("myAccountLogin", function() {
              ...
              var n = e.createIframeFn ? e.createIframeFn : F
                , r = n(e);
              if (!r) {
                t.doneCall("offerCreate"),
      ...
      var r = e.Deferred()
        ...
        promise: i,
        show: function() {
          i.pipe(J).pipe(s.promise).then(function(e) {
            U(e),
            Y(n) && Z(e.iframeId),
              K(n)
          }, function() {
      ...
      return n.displayMode !== "popup" && n.offerId ? t.waitCall("refreshAccessTokenList", function() {
        n.isPreload = !0,
          t.startCall("offerCreate");
        var e = n.createIframeFn ? n.createIframeFn : F
          , i = e(n);
        i ? (i.element.load(function() {
          s.resolve(i)
        }),
          r.resolve(i)) : (t.doneCall("offerCreate"),
          t.error("Could not initialize offer; check configuration"),
          r.reject())
      }) : r.reject(),
        o
      ...
      , et = function(e, n) {
      var i = N.hasCallback("loginRequired");
      if (e.isSiteLicensing && i && ot()) {
        l.refreshUser(T.iframeId);
        return
      }
        ...
        t.waitCall("refreshUserToken", function() {
          t.waitCall("refreshAccessTokenList", function() {
            ...
            s.__protected__.addChildToInlineIframe(i, n),
              i ? g && t.waitCall("offerCreate", function() {
                g = !1;
                var e = {};
                e.userProvider = r.getProvider().getName(),
                  e.userToken = r.getProvider().getToken() && r.getProvider().getToken().length > 0 ? r.getProvider().getToken() : "",
      ...
      if (r) {
        var i = {
          ...
          var o = e.extend({}, n);
          return o[r] = t.getQueryParamByName(i[r]),
            s.push(i[r]),
            o
        }, {});
  ...
  tp.define("template", ["jq", "util", "postmessage", "containerUtils", "user", "sha1", "api", "versionService"], function(e, t, n, r, i, s, o, u) {
    function a(e) {
      return l(e, "/checkout/template/show")
    }
    function f(e) {
      return e.cacheableTemplateContextPromise = c(e),
        l(e, "/checkout/template/cacheableShow")
    }
    function l(e, t) {
      const n = tp.getEndpointRoot(!0) + t;
      return e.iframeUrl = n,
        e.postMessageUrl = n,
        e.widget = "template",
        tp.offer.createOfferIframe(e)
    }
    function c(t) {
      var n = i.getUserInfoParams(t);
      n.tracking_id = t.trackingId,
        n.aid = tp.aid;
      var r = e.Deferred();
      return o.callApi("/anon/template/loadTemplateContext", n, function(e) {
        e.code === 0 ? r.resolve(e.templateContext) : r.reject(e.message)
      }, undefined, undefined, !0),
        r.promise()
    }
    function h(t) {
      var n = {}
        , r = ["aid", "templateId", "templateVariantId", "previewTemplateVersion", "preload", "preview", "previewUncached", "deploymentItemId", "gaClientId", "zuoraSelectedRatePlanIds", "newscycleSelectedIds", "addNewsletterAssets", "offerId", "experienceId", "iframeId", "displayMode", "debug"];
      e.each(r, function(e, r) {
        t[r] && (n[r] = t[r])
      });
      var i = e.param(n, !0);
    ...
    function p(e, t) {
      var n = 0
        , r = "offer_" + s.hash(e.iframeUrl + "?" + h(e), 20);
      return t.has(r) && (n = t.get(r) + 1),
        t.set(r, n),
      r + "-" + n
    }
    function d(e) {
      e.trackStatsOnShow = !1,
        ...
        e.buildQueryStringFn = h,
        e.generateIframeIdFn = p
    }
    function v(e) {
      tp.cacheableShowTemplate ? (d(e),
        e.createIframeFn = f) : e.createIframeFn = a
    }
    return {
      name: "template",
      show: function(e) {
  ...
  tp.define("myaccount", ["jq", "util", "postmessage", "offer", "user", "containerUtils", "pianoId", "logging"], function(e, t, n, r, i, s, o, u) {
    function b(t) {
      t.outerHeight() > e(window).height() ? (l === !1 && (t.css({
        position: "absolute"
      }),
        l = !0),
        t.css({
    ...
    var a = "verification_code"
      ...
      , h = tp.isSensitiveDataProtectionEnabled
      , p = function() {
      ...
      e.config.displayMode === "modal" && (e.element.css("width", t.width + "px"),
      ...
      f.html(t.cancel ? t.cancel : "Cancel"),
        s.on("click", y(n, t, "cancel")),
        f.on("click", y(n, t, "cancel")),
        a.on("click", y(n, t, "ok")),
        i.append(s),
        i.append(o),
        u.append(a),
      ...
      , w = function(e, t) {
      g(t.params, function(e) {
        n.send("closeDialog", e, f[t.sender].iframeId)
      })
    }
      , E = function(e, t) {
      c[e] = c[e] || [],
      ...
      for (var s = 0; s < c[e].length; ++s) {
        ...
        var o = c[e][s](r);
        r && r.resultCallbackId && (r.result = o,
          r.event = e,
          n.send("resultCallback", r, i))
      }
      !c[e].length && r && r.resultCallbackId && (r.callbackNotFound = !0,
        r.event = e,
        n.send("resultCallback", r, i))
    }
      , x = function(e) {
      ...
      switch (e.event) {
        case "resize":
          t.debug("*** Resize event", e.params.width, e.params.height),
            v(f[e.sender], e.params),
          f[e.sender].config.displayMode === "modal" && b(f[e.sender].container);
          break;
        case "startCheckout":
          _startCheckout(e.params);
          break;
        case "loaded":
          n.send("initMaxHeight", {
            height: f[e.sender].config.maxHeight
          }, f[e.sender].iframeId),
            v(f[e.sender], e.params),
          i.getProvider().name === "pianoId" && tp.pianoId.__protected__.executePostMessagesBatch(),
          f[e.sender].config.displayMode === "modal" && (backdrop.show(),
            window.setTimeout(function() {
              backdrop.addClass("tp-active"),
                f[e.sender].container.addClass("tp-active"),
                b(f[e.sender].container)
            }, 25));
          break;
        case "close":
          break;
        ...
        case "userProfileUpdateSuccess":
          var s = e
            ...
            , a = s.params
            , l = s.sender;
          i.getProvider().onLoginSuccess(a);
          var c = {
            userProvider: a.user_provider,
          ...
          for (var h in f)
            if (f.hasOwnProperty(h)) {
              var p = f[h]
                , d = p.config;
              d.hasOwnProperty("userToken") && delete d.userToken,
                O(d)
            }
          break;
        ...
        case "getTrackingData":
          n.send("getTrackingDataResponseEvent", {
      ...
      , N = function(n) {
      n.keyCode === 27 && e.map(f, t.mapArrayIndex).length > 0 && _closeContainer()
    }
      , C = function(e) {
      var t = f[e].element[0].getBoundingClientRect()
        , r = {
        iframeRect: {
          bottom: t.bottom,
          height: t.height,
      ...
      for (var e in f) {
        var t = f[e]
          , r = !1;
        t.container.width() !== t.containerWidth && (t.element.css("width", t.container.width()),
          t.containerWidth = t.container.width(),
          r = !0),
        t.container.height() !== t.containerHeight && (t.element.css("height", t.container.height()),
      ...
      if (typeof r.displayMode == "undefined")
      ...
      return t.waitCall("refreshUserToken", function() {
        ...
        for (var l in c)
          typeof r[l] == "function" && (t.debug("Registering " + l + " callback for iframe " + o.iframeId),
            E(l, r[l]));
        o.aid = tp.aid,
        h && (a = {
          ...
          delete o.userToken);
        var v = p() + "?" + e.param(o, !0)
          , m = e(document.createElement("iframe"));
        m.attr({
          id: o.iframeId,
          name: o.iframeId,
          scrolling: "no",
          ...
          m.css("height", "0px"),
        h || m.attr("src", v),
          r.displayMode === "inline" ? m.css("width", o.width + "px") : m.css("width", "0px"),
          f[o.iframeId] = {
            iframeId: o.iframeId,
            config: r,
            element: m,
  ...
  tp.define("util", ["jq", "versionService", "itp"], function(e, t, n) {
    ...
    function R(e) {
      e.browser && e.browser.app_timezone_offset !== undefined ? q(e.browser.app_timezone_offset) : e.timezone_offset !== undefined && q(e.timezone_offset)
    }
    function U(t) {
      var n = f(/^tpcc_.+/);
    ...
    function K() {
      var e = i.NOT_DETECTED
        , t = V();
      return tp.adblockerCookieName && (e = X(tp.adblockerCookieName)),
      e === i.NOT_DETECTED && (e = X("__pac")),
      e === i.NOT_DETECTED && (e = X("__adblocker")),
        $(t.cookieValue, e),
      e === i.ENABLED && (t.isFirst || J(t.cookieValue) || (e = i.ENABLED_AFTER_DISABLED)),
        e
    }
    function Q() {
      var e = "";
    ...
    function tt(e, t) {
      if (G[e]) {
        ...
        if (G[e].counter <= 0) {
          var n = [];
          G[e].waiters.forEach(function(e) {
            n.push(e)
          }),
            delete G[e],
    ...
    function nt(e) {
      ...
      if (e.match(/\s+ET$/)) {
        var n = new Date;
        n.getTimezoneOffset() === 240 ? e = e.replace(/\s+ET$/, " EDT") : e = e.replace(/\s+ET$/, " EST")
      }
      e = e.trim(),
        t = Date.parse(e);
      if (t)
    ...
    function vt(e, t) {
      var n = []
        , r = e.indexOf(t);
      return r === -1 ? n.push(e) : (n.push(e.substr(0, r)),
        n.push(e.substr(r + 1))),
        n
    }
    function mt(e) {
    ...
    function gt(e) {
      var t = vt(e, "="), n, r;
      typeof e != "undefined" && (n = t[0],
        r = t[1]);
      var i = "";
      return typeof n != "undefined" && (i += encodeURIComponent(decodeURIComponent(n))),
    ...
    function bt(e) {
      ...
      return t.hasQueryString && (n += "?" + yt(t.queryString)),
    ...
    function Et(e) {
      var t = e.split(".")
        , n = !0;
      if (t.length === 4) {
        if (!wt(t[0]) || !wt(t[1]) || !wt(t[2]) || !wt(t[3]))
          n = !1
      } else
        n = !1;
      return n
    ...
    function St(e) {
      var t = document.createElement("a")
        , n = /^https?:\/\//i;
      t.href = n.test(e) ? e : "http://" + e;
      var r = t.hostname;
      return r.indexOf("www.") === 0 && (r = r.replace("www.", "")),
        r
    }
    function xt(e, t, n) {
      var r;
    ...
    function At(e) {
      ...
      var t = e || window.location.href
        , n = St(t);
      return Et(n) ? n : n === "localhost" ? null : "." + n
    }
    function Ot(e, t) {
      try {
        var n = new Error
    ...
    function _t(e) {
      ...
      document.readyState === "complete" || document.readyState !== "loading" && !document.documentElement.doScroll ? window.setTimeout(e) : (document.addEventListener("DOMContentLoaded", t),
    ...
    function Ht(t, r, i) {
      i = i || {},
        tp.aid === "11C6aYHwtb" ? (i.samesite = "none",
          i.secure = !0) : i.samesite = "lax",
      i.expires && (i.expires = Dt(i.expires)),
        e.cookie(t, r, i),
        n.synchronizeCookie()
    }
    function Ft() {
    ...
    function qt() {
      ...
      while (e.length < 16)
        e += Math.round(Math.random() * 2147483647).toString(36);
      return e.substr(0, 16)
    }
    function Rt(t) {
      var n = Bt + t
        , r = e.localStorage.get(n)
        , i = e.localStorage.get(n + jt);
      return i && i < Ft() ? (zt(t),
        null) : r
    }
    function Ut(t, n, r) {
      var i = Bt + t;
      e.localStorage.set(i, n),
      r && e.localStorage.set(i + jt, Ft() + r)
    }
    function zt(t) {
      var n = Bt + t;
      e.localStorage.remove(n),
        e.localStorage.remove(n + jt)
    }
    function Wt() {
    ...
    function $t() {
      ...
      for (var o in window.document)
        if (o.match(/\$[a-z]dc_/) && window.document[o].cache_)
          return !0;
    ...
    function Qt(e) {
      ...
      if (t) {
        var n = t.split("=");
        if (n[0] && n[1] && n[0] === e)
          return history.pushState("", document.title, window.location.href.split("#")[0]),
            n[1]
      }
      return ""
    }
    ...
    var s = function(e) {
      ...
      , p = function() {
      var e = 0;
      return window.pageYOffset ? e = window.pageYOffset : (e = document.documentElement || document.body.parentNode,
      ...
      , y = function() {
      var e, t;
      return "CSS1Compat" === document.compatMode ? (e = document.documentElement.clientWidth,
      ...
      if (i.length >= 2) {
        ...
        for (j = 0; j < t.length; j++) {
          ...
          for (var u = s.length; u-- > 0; )
            s[u].lastIndexOf(o, 0) !== -1 && s.splice(u, 1)
        }
        return e = i[0] + (s.length > 0 ? "?" + s.join("&") : ""),
          n ? e + "#" + n : e
      }
      return e
    }
      ...
      if (t && e.type(t.value) === "string") {
        ...
        t.cookie_domain && t.cookie_domain !== "localhost" && e.inArray(t.cookie_domain, W()) >= 0 && (u.domain = t.cookie_domain),
          Ht("__tac", t.value, u),
          Ht("__tae", s.getTime(), u),
          Ht(i, n, u),
        n === "" && !r && Ot(t, n)
      } else {
        var a = W();
      ...
      , k = function(e) {
      typeof e.browser != "undefined" && typeof e.browser.cookie_domain != "undefined" && tt("domainIsReceived", e.browser.cookie_domain),
      e.tbc && e.tbc.cookie_domain && tt("domainIsReceived", e.tbc.cookie_domain)
    }
      , L = function(e) {
      try {
      ...
      e.browser.cookie_domain && (t.domain = e.browser.cookie_domain,
        u("__tbc", e.browser.cookie_domain)),
        o("__tbc"),
        Ht("__tbc", e.browser.tbc, t)),
      e.tbc && e.tbc.cookie_value && (t = {
        path: "/",
        expires: 730
      },
      e.tbc.cookie_domain && (t.domain = e.tbc.cookie_domain,
        u("__tbc", e.tbc.cookie_domain)),
        o("__tbc"),
        Ht("__tbc", e.tbc.cookie_value, t))
    }
      , O = function() {
      return Pt("__tbc")
    }
      , M = function() {
      var e, t, n = "get_top_level_domain_cookie", r = document.location.hostname.split(".");
    ...
    return {
      name: "util",
      __private__: {
        getAdjustedCookieExpiration: Dt
      },
      __protected__: {
        ...
        getCookie: Pt,
        setCookie: Ht,
        getLocalStorageItem: Rt,
        hasLocalStorage: It,
        randomStringCxCompatible: qt,
        setLocalStorageItem: Ut,
        removeLocalStorageItem: zt,
        cameFromFbSubscriptions: Wt,
        logRemoveTokens: Mt,
        waitAllPromises: Xt,
        isInteger: v,
        racePromise: Vt,
      ...
      removeVoucherCodeFromUrl: function(e) {
        return Lt(e, "voucher_code")
      },
      removeSharedAccountCodeFromUrl: function(e) {
        return Lt(e, "shared_account_code")
      },
  ...
  tp.define("postmessage", ["jq", "util"], function(e, t) {
    ...
    var n = {}
      ...
      , f = function(t, i, s) {
      var o, u = {}, a = r[s].config.displayMode === "popup" ? "opener" : "parent";
      u.sender = v(s) ? a : s,
        u.recipient = v(s) ? s : a,
        u.event = t,
        u.params = i;
      ...
      , l = function(e) {
      e.keyCode === 27 && d(e.data.iframeId) && m(e.data.iframeId) && u("close", null, e.data.iframeId)
    }
      , c = function(r, i) {
      h(r.iframe);
      if (!r.postMessageUrl) {
      ...
      n[r.iframe.iframeId].initializedKeystrokeHandler || (n[r.iframe.iframeId].initializedKeystrokeHandler = !0,
        e(window).on("keyup", r.iframe, l)),
        n[r.iframe.iframeId].postMessageUrl = r.postMessageUrl,
      n[r.iframe.iframeId].initializedListener || (n[r.iframe.iframeId].initializedListener = !0,
      ...
      t.debug((d(s.sender) ? "iframe(" + s.recipient : "the parent") + ") received event '" + s.event + "' from iframe(" + s.sender + ")", s),
  ...
  tp.define("user", ["api", "util", "jq", "janrain", "tinypassAccounts", "condeUserProvider", "gigya", "pianoId", "pianoIdLite", "eventUtils"], function(e, t, n, r, i, s, o, u, a, f) {
    var l = f.createEventManager([])
      ...
      , d = function(e) {
      var t = h().getName();
      if (t === "tinypass_accounts")
        i.login(e);
      else if (t === "piano_id") {
        var n = e || {};
        u.show(n)
      } else
        t === "publisher_user_ref" && l.fireCallbacks("loginRequired", {}, null, !0)
    }
      , v = function() {
      ...
      , b = function(e) {
      var t = e.userToken;
      return t || (t = h().getToken() && h().getToken().length > 0 ? h().getToken() : ""),
        {
          user_token: t,
          user_lang: y(),
  ...
  tp.define("meter", ["jq", "util", "api", "offer", "eventUtils", "main"], function(e, t, n, r, i, s) {
    var o = function() {
      ...
      return u.fire(undefined, e, !0, n),
        S[e] && typeof S[e] == "function" ? (t.debug("_customCaller called with " + e),
          S[e](n)) : !0
    }
      , p = function(t) {
      t = t || {},
  ...
  tp.define("jwtDecode", [], function() {
    ...
    function n(n) {
      ...
      for (var i = 0, s, o, u = 0, a = ""; o = r.charAt(u++); ~o && (s = i % 4 ? s * 64 + o : o,
      i++ % 4) ? a += String.fromCharCode(255 & s >> (-2 * i & 6)) : 0)
        o = e.indexOf(o);
      return a
    }
    function s(e) {
  ...
  tp.define("janrain", ["jq", "api", "util", "eventUtils"], function(e, t, n, r) {
    ...
    function N() {
      ...
      janrain.events.onCaptureSessionFound.addHandler(function(t) {
        C() ? e && (n.log("JANRAIN: Events received for logged in user", t),
          S()) : S()
      }),
        janrain.events.onCaptureSessionNotFound.addHandler(function(t) {
          C() ? e && (n.log("JANRAIN: Events received for logged out user", t),
            S()) : S()
        }),
    ...
    var i = r.createEventManager(["userChanged", "logout"])
      ...
      if (f.settings) {
        ...
        var i = f.appName.replace(/\./g, "-"), u = "http://widget-cdn.rpxnow.com/load/" + i, a = "https://rpxnow.com/load/" + i, l;
        n.__protected__.isHttpsProtocol() ? l = a : l = u,
          tp.push(["addExternalLibrary", l, function() {
            janrain.ready = !0
          }
          ])
      }
      n.log("JANRAIN:", "start refresh user token"),
        n.startCall("refreshUserToken", 3e4),
      ...
      , v = function(e) {
      if (typeof a[e] == "undefined" || a[e].length === 0)
        return;
      for (var t = 0; t < a[e].length; ++t)
        a[e][t].apply(null, arguments)
    }
      , m = function(e, t) {
      function i() {
        if (u)
          ...
          n.startCall("refreshUserToken"),
            t.callApi("/anon/gigya/verifyAccountInfo", i, function(t) {
              if (t && t.result) {
                ...
                n.log("Can't verify gigya user: may be the configuration of gigya user provider is invalid"),
                  n.setAccessTokenListCookie();
              l = [],
                n.doneCall("refreshUserToken")
            })
  ...
  tp.define("tinypassAccounts", ["jq", "api", "util", "tinypassLogin", "eventUtils"], function(e, t, n, r, i) {
  ...
  tp.define("tinypassLogin", ["jq", "util", "postmessage", "require-css/css!styles/offer", "containerUtils", "eventUtils", "logging"], function(e, t, n, r, i, s, o) {
    function v(e) {
      n.broadcast("reloadOffer", e)
    }
    function g(t, n) {
    ...
    var u = null
      , a = !1
      , f = s.createEventManager(["resize", "loginSuccess", "logout"])
      , l = function() {
      ...
      switch (e.event) {
        ...
        case "close":
          i.closeModalContainer(),
            f.fireCallbacks(e.event, e.params, e.sender, r);
          break;
        case "cancel":
        case "error":
        case "customEvent":
      ...
      , p = function(e, n, r) {
      f.fireCallbacks("logout", null, null, !0),
        t.setAccessTokenListCookie({
          value: n.token_list,
      ...
      o && o.config && o.config.loginSuccess && o.config.loginSuccess("loginSuccess", {}, {}),
        f.fireCallbacks("loginSuccess", {}, {}, u)
    }
      , b = null
      , w = function(n) {
      b && i.closeModalContainer(b);
      var r = {
        closeAfterSuccess: !0
      }
        , s = {};
      ...
      n.userToken && (o.user_token = n.userToken),
        t.getCampaigns(o);
      var u;
      return s.iframeId ? (o.iframeId = s.iframeId,
        ...
        f.registerCallback(s, o.iframeId),
        u
    }
      , E = function(e) {
      if (u)
      ...
      w(e) || t.error("Could not initialize login; check configuration"),
        o.setTime("tpAccShow")
    }
      , S = function(e) {
      f.registerCallback(e, e.iframeId);
      var t = {
        iframeId: e.iframeId,
        config: e,
        iframeParams: e
  ...
  tp.define("containerUtils", ["util", "jq", "postmessage", "eventUtils", "sha1"], function(e, t, n, r, i) {
    function p(e) {
      var t = document.querySelector(".tp-iframe-wrapper");
      if (e)
        return t.classList.contains("no-shadow") && t.classList.remove("no-shadow");
      t.classList.add("no-shadow")
    }
    function N(e) {
      var t = b(e);
      t.config.child && T(t.config.child),
        T(e)
    }
    function C(e) {
    ...
    function X(e, t) {
      ...
      if (e.container)
        return e.container;
      var n = new w;
      return e.isPreload || (_ = n.element),
    ...
    function V(n) {
      ...
      if (!n.iframeParams.containerSelector)
        return e.log("Inline offer must have a valid containerSelector"),
          r;
      r.container = t(n.singleContainer),
        r.container.empty();
      if (!r.container.length) {
        if (t.isReady)
          return e.log("Invalid containerSelector"),
            r
      } else {
        var i = n.config
        ...
        if (s) {
          ...
          n.iframeParams.width = n.iframeParams.width || r.container.width();
        r.containerReady = !0
      }
      return r
    }
    ...
    function Y(t) {
      if (t.config.displayMode === "modal") {
        ...
        t.config.displayMode === "inline" ? E(t) : e.log("Unexpected displayMode of preloaded iframe\n");
    ...
    function Z(r) {
      var a, l = !0, c = r.iframeParams;
      c.displayMode !== "inline" && !c.width && (c.width = t(window).width());
      var h;
      r.config.buildQueryStringFn ? h = r.config.buildQueryStringFn : h = function(e) {
        var n = t.param(e, !0);
      ...
      if (c.displayMode === "popup") {
        ...
        o[c.iframeId] = {},
          ...
          o[c.iframeId].interval = setInterval(function() {
            o[c.iframeId].container.closed && (clearInterval(o[c.iframeId].interval),
      ...
      if (c.displayMode === "modal")
        ...
        if (s[c.iframeId].containerReady) {
          ...
          r.config.isPreload && w.hide(),
            (document.readyState === "complete" || document.readyState !== "loading" && !document.documentElement.doScroll) && a && a.length > 0 ? (a.empty(),
              a.append(w)) : tt(a, w)
        } else {
    ...
    function et(e, r) {
      var i = r.url + "?" + t.param(r.iframeParams, !0)
        , o = s[e];
      if (o.config.displayMode === "popup")
        o.container.location = i;
      else {
    ...
    function it(e) {
      ...
      for (var n in s) {
        ...
        if (e && n !== e)
          continue;
        if (r.config.displayMode === "inline")
          continue;
        r.config.displayMode === "modal" && (k(r),
          r.container.hide(),
          t.push(n))
      }
      return t
    ...
    function at() {
      if (l)
        return;
      l = ut('<div class="tp-please-wait tp-active tp-overlap"><div class="tp-icon tp-centered"></div></div>'),
    ...
    function lt(e, t) {
      e.container.addClass(t)
    }
    function ct(e) {
      e.container[0].setAttribute("dir", "rtl")
    }
    function ht(e) {
      e.container[0].removeAttribute("dir")
    }
    var s = {}
      , o = []
      ...
      applyFix: function() {
        var t = window.visualViewport ? Math.max(window.scrollY, document.documentElement.scrollTop, window.visualViewport.pageTop) : Math.max(window.scrollY, document.documentElement.scrollTop)
          , n = tp.dontScrollTopModal ? t : 0
          , r = "100%";
        this.saveInitialScroll(window.scrollX, t),
        _ && (tp.dontScrollTopModal ? (document.body.style.touchAction = "none",
          document.documentElement.style.touchAction = "none",
          this.addEvents("scroll"),
          this.addEvents("touchmove")) : (document.body.style.position = "fixed",
          document.body.style.width = "100%",
          document.body.style.margin = "0",
        e.isIOS() && !e.isFBOrInstWebView() && !e.isCriOS() && (r = "calc(100% - " + this.iOSBottomToolbarHeight + "px)"),
          h(0, 0)),
          setTimeout(function() {
            _.css({
      ...
      removeFix: function() {
        if (document.querySelectorAll(".tp-iframe-wrapper.tp-active").length)
          return;
        tp.dontScrollTopModal ? (document.body.style.removeProperty("touch-action"),
          document.documentElement.style.removeProperty("touch-action"),
          this.removeEvents("scroll"),
          this.removeEvents("touchmove")) : (document.body.style.removeProperty("position"),
    ...
    t(window).resize(function() {
      nt();
      if (e.isAndroid()) {
        const n = t(".tp-iframe-wrapper.tp-active").parent(".tp-modal")
          , r = n.length ? n[0] : null;
        r && r.scrollBy(0, 1)
      }
    }),
    e.isIOS() && window.addEventListener("orientationchange", function() {
      setTimeout(function() {
        nt()
      }, 100)
    }),
    ...
    var d = function(t) {
      ...
      for (var e in s) {
        var t = s[e];
        if (t.config.displayMode === "modal" && !t.waitFinishProcesses && !t.config.isPreload)
          return !0
      }
      return !1
    }, b = function(e) {
      ...
      var e, n, r, i, s = function() {
        return e ? e : (e = t(document.createElement("div")).addClass("tp-modal"),
          n = t(document.createElement("button")).attr("type", "button").attr("aria-label", "Close").addClass("tp-close"),
      ...
      _ = e.container.closest(".tp-modal"),
        R(e, !0, !0)
    }, x = function(n) {
      ...
      for (var i in s) {
        ...
        if (t && i !== t)
          continue;
        if (r && o.config.displayMode === "inline")
          continue;
        if (r && o.config.isPreload)
          continue;
        g(o),
        o.config.displayMode === "modal" && k(o)
      }
      u.fireCallbacks("close", null, t, !0)
    }, L, A, O = 250, M = function() {
      if (L)
        return L;
      ...
      if (t.is(":visible"))
        return;
      W("body", function(e) {
        e.removeClass("tp-modal-close"),
          e.addClass("tp-modal-open")
      }),
        _timer = setTimeout(function() {
          t.show()
        }, 100),
      (e.isIphone() || e.isSafariOrIOsUiWebView() || e.isAndroid()) && c.modalOpened()
    }, H = function() {
      if (!_)
        return;
      W("body", function(e) {
      ...
      var r = e.container
        , i = r.parent();
      !i || !i.hasClass("tp-modal") ? i = _ : _ = i,
        e.iframeParams = e.iframeParams || {},
      e.iframeParams.shown || (e.iframeParams.shown = !0,
        B(i, t, n),
      n || (r.hasClass("tp-active") || r.addClass("tp-active"),
        I(r)))
    }, U = function(e) {
      if (e) {
      ...
      var o = {
        ...
        hasIframeCallback: function(e, t) {
          ...
          if (i[e] && i[e].length > 0)
            for (s = 0,
                   n = null,
                   r = null; s < i[e].length; ++s) {
              r = i[e][s];
              if (typeof r == "object" && t === r.iframeId)
                return !0
            }
          return !1
        },
        ...
        registerCallback: function(e, n) {
          var r = typeof e == "string" ? e : null, s = typeof e == "object" ? e : null, o, u, a;
          if (r) {
          ...
          if (s) {
            ...
            for (a in i)
              typeof s[a] == "function" && (t.debug("Registering " + a + " callback for iframe " + u),
                i[a].push({
                  iframeId: u,
                  callback: s[a]
                }))
        ...
        fire: function(r, s, o, u) {
          ...
          var a, f, l, c = !1, h = [].slice.call(arguments);
          h.splice(0, 3);
          ...
          for (l = 0,
            ...
            p && (u.result = a,
              u.event = s,
              n.send("resultCallback", u, r))
          }
          !c && p && (u.callbackNotFound = !0,
            u.event = s,
            n.send("resultCallback", u, r))
        },
  ...
  tp.define("experience", ["jq", "util", "postmessage", "api", "eventUtils", "scrollDepth", "viewportExit", "idle", "interaction", "log", "pianoEsp", "swg", "fbsubscriptions", "user", "cxense", "logging"], function($, util, postmessage, api, eventUtils, scrollDepth, viewportExit, idle, interaction, log, pianoEsp, swg, fbsubscriptions, user, cxense, logging) {
    ...
    function _init() {
      ...
      e && _executePromise("auto").then(function() {
        logging.setTime("expExec")
      })
    }
    ...
    function getTrackingEndpoint() {
      return tp.getTrackingEndpoint(tp.composerHost) + "/api/v3"
    }
    function getComposerUrl() {
      var e;
      return util.__protected__.cameFromFbSubscriptions() ? (e = "/xbuilder/experience/executeFbia",
        initializeFbSubscriptions()) : e = "/xbuilder/experience/execute",
    ...
    function sendCxensePageViewEvent(e) {
      return cxense.__protected__.sendPageViewEvent({
        ...
        pageViewId: tp.main.fetchPageViewId(),
        eventExecutionContext: me.__private__.createExperienceExecutionContext(e.result)
      })
    }
    ...
    function _executePromise(e, t, n) {
      ...
      return setTimeout(function() {
        ...
        util.__protected__.racePromise([tp.main.__protected__.externalResourcesDelay(), i.promise()]).then(function(r) {
          $.isPlainObject(r) || (util.error("exp: error get external resources ", r),
            r = {}),
            me.__private__.isCxenseActivated() ? (util.debug("c1x: integration is activated"),
              me.__private__.loadCxLibIfNeeded(),
              _execute(e, $.extend(!0, t, r, {
                c1x_integration_version: "v2",
                new_bid: me.__private__.getOrGenerateCxCompatibleBid()
              }), n)) : _execute(e, $.extend(!0, t, r), n)
        })
    }
      ...
      util.hasQueryParamByName(me.__private__.READER_ID) && (r[me.__private__.READER_ID] = util.getQueryParamByName(me.__private__.READER_ID)),
        util.waitCall("refreshUserToken", function() {
          if (!n) {
            ...
            r.executed_nodes = JSON.stringify(me.__private__.executedHandlers);
          util.debug("exp: Experience initialized with params:", r),
            util.waitCall("refreshAccessTokenList", function() {
              ...
              var e = getComposerUrl(), t = navigator.appVersion.indexOf("MSIE 9") !== -1, i;
              if (t)
                i = {
                  dataType: "jsonp",
                  url: e + "?" + $.param(r, !0)
    ...
    function _applyEspMailingListParams(e) {
      e.mailing_lists = JSON.stringify(pianoEsp.__protected__.loadCompleteMailingLists())
    }
    ...
    function processErrors(e) {
      Array.isArray(e) && (e.length && util.debug("exp: composer execution has been failed with errors"),
        $.each(e, function(e, t) {
    ...
    function createLinkedNodeEventCondition(e, t) {
      return function() {
        var n = !1
          ...
          n = !0,
          me.__private__.smallExpereinceMode && me.__protected__.sendStatisticsExecutedNodes("chain")
        };
        return {
    ...
    function initSwgIfNeeded(e) {
      e.swgMarkupData && (util.debug("exp: swg markup data :", e.swgMarkupData),
    ...
    function createExperienceExecutionContext(e) {
      if (!e) {
      ...
      for (var n = 0; n < e.events.length; n++) {
        ...
        try {
          var i = r.eventType;
          i === "experienceExecute" && ($.extend(!0, t, r.eventExecutionContext),
            t.result = {},
            $.extend(!0, t.result, e))
        } catch (s) {
          util.error("exp: error on execute event: ", r, s)
        }
      }
      return t
    }
    function processResult(e, t) {
      ...
      if (e.xbc && e.xbc.cookie_value) {
        ...
        e.xbc.cookie_domain && e.xbc.cookie_domain !== "localhost" && (n.domain = e.xbc.cookie_domain,
          util.__protected__.deleteTLDCookieForSpecificDomains(XB_COOKIE, e.xbc.cookie_domain)),
      ...
      for (var f = 0; f < r.events.length; f++) {
        ...
        try {
          ...
          c === "experienceExecute" && ($.extend(!0, i, l.eventExecutionContext),
            i.result = {},
            $.extend(!0, i.result, r)),
            u = h.moduleId;
          if (!u) {
    ...
    function _dumpElementWithChildren(e) {
      ...
      for (var n = 0; n < t.children.length; n++)
        e.children.push(_dumpElementWithChildren({
    ...
    function _dumpRootEventConditions(e) {
      var t = [];
      for (var n = 0; n < e.length; n++)
        t.push(_dumpElementWithChildren({
          moduleId: e[n],
          children: []
        }));
    ...
    function show(e, t) {
      ...
      if (e.eventType === "showZuoraOffer") {
        ...
        a && a.length > 0 && (n.zuoraSelectedRatePlanIds = JSON.stringify(a),
          n.additionalParamNames.push("zuoraSelectedRatePlanIds"))
      }
      if (e.eventType === "showNewscycleOffer") {
        var f = e.eventParams.ids;
        f && f.length > 0 && (n.newscycleSelectedIds = JSON.stringify(f),
      ...
      if (e.eventType === "showNewsletterSignup") {
        ...
        l && l.length > 0 && (n.mailingListIds = JSON.stringify(l),
          n.siteId = c,
          n.additionalParamNames.push("mailingListIds", "siteId"))
      }
      return e.eventType === "showRecommendations" && (n.widgetId = e.eventParams.widgetId,
        n.placeholder = e.eventParams.placeholder),
      s && (n.formNameByTermId = JSON.stringify(s),
        n.hideCompletedFields = o),
    ...
    function _buildCallbackEventHandler(e) {
      return function(t) {
        ...
        n && e !== n && (util.debug("exp: execute event ", e, " with callback: ", n),
          _runScript(n))
      }
    }
    ...
    me.name = "experience",
      ...
      me.__private__.createExperienceExecutionContext = createExperienceExecutionContext,
    ...
    var statisticsRequestInterval = 2e3, sendStatisticsTimerId;
    return me
  }),
  ...
  tp.define("activetimer", ["ifvisible", "jq"], function(e, t) {
    function a() {
      b();
      var e = r[r.length - 1];
      if (e !== undefined && e.stopTime === undefined)
        return;
      r.push({
        startTime: new Date,
        startMinute: n,
    ...
    function f() {
      ...
      var e = r[r.length - 1];
      e.stopTime === undefined && (e.stopTime = new Date,
        e.stopMinute = n)
    }
    function l() {
      var e = 0;
  ...
  tp.define("scrollDepth", ["jq", "util"], function(e, t) {
    ...
    function u() {
      var t = document
        ...
        , o = t.body || {}
        , u = t.documentElement || {}
        , a = Math.max(o.scrollHeight, u.scrollHeight, o.offsetHeight, u.offsetHeight, o.clientHeight, u.clientHeight)
  ...
  tp.define("ifvisible", [], function() {
    ...
    return a = {},
            ...
            if (r) {
              if (e[n] && s[e[n]] && s[e[n]][t]) {
                ...
                for (o = u = 0,
                  ...
                  i = f[o];
                  if (i === r)
                    return s[e[n]][t].splice(o, 1),
                      i
                }
              }
            } else if (e[n] && s[e[n]] && s[e[n]][t])
      ...
      r = function(e, t) {
        var r;
        return n.createEventObject ? e.fireEvent("on" + t, r) : (r = n.createEvent("HTMLEvents"),
          r.initEvent(t, !0, !0),
          !e.dispatchEvent(r))
      }
      ,
      ...
      i = !1,
      p = void 0,
      typeof n.hidden != "undefined" ? (i = "hidden",
        p = "visibilitychange") : typeof n.mozHidden != "undefined" ? (i = "mozHidden",
        p = "mozvisibilitychange") : typeof n.msHidden != "undefined" ? (i = "msHidden",
        p = "msvisibilitychange") : typeof n.webkitHidden != "undefined" && (i = "webkitHidden",
      ...
      a = {
        ...
        focus: function(e) {
          return typeof e == "function" ? this.on("focus", e) : (c = "active",
            t.fire(this, "focus"),
            t.fire(this, "wakeup"),
        ...
        blur: function(e) {
          return typeof e == "function" ? this.on("blur", e) : (c = "hidden",
            t.fire(this, "blur"),
            t.fire(this, "idle"),
            t.fire(this, "statusChanged", {
              status: c
        ...
        idle: function(e) {
          return typeof e == "function" ? this.on("idle", e) : (c = "idle",
            t.fire(this, "idle"),
            t.fire(this, "statusChanged", {
              status: c
            })),
        ...
        wakeup: function(e) {
          return typeof e == "function" ? this.on("wakeup", e) : (c = "active",
            t.fire(this, "wakeup"),
            t.fire(this, "statusChanged", {
              status: c
            })),
  ...
  tp.define("doubleClickForPublisher", [], function() {
    ...
    function v(n) {
      ...
      var r = d(n)
        , s = g(n.slot);
      e[s] ? r.viewed = e[s].viewed : t.push(s),
        e[s] = r,
        a(r, s)
    }
    function m(n) {
  ...
  tp.define("viewportExit", ["jq", "util"], function(e, t) {
    ...
    function g() {
      ...
      c = !0,
        window.addEventListener("popstate", function(e) {
          i && e.state && e.state.pianoViewportExitState === n && (i = !1,
            N("back"))
        });
      var e = window.history.state || {};
      e && e.pianoViewportExitState !== r && (e.pianoViewportExitState !== n && (e.pianoViewportExitState = n,
        window.history.replaceState(e, document.title)),
    ...
    function y(e) {
      a.indexOf(e) !== -1 ? d[e].visited || (d[e].visited = !0,
        v += d[e].value) : t.debug("viewportExit: the detect of the exit side failed")
    }
    function b(t, n) {
      function o() {
        return n <= 0
    ...
    function x(e) {
      ...
      n || (n = E(),
      n || t.debug("viewportExit: the detect of the exit side failed")),
      n && y(n),
        N("all"),
      n === "top" && N("top")
    }
  ...
  tp.define("pianoId", ["jq", "jwtDecode", "util", "containerUtils", "postmessage", "log", "observer", "main", "gaService", "api", "pianoIdLite", "logging"], function(e, t, n, r, i, s, o, u, a, f, l, c) {
    function R(e) {
      O.filter(function(e) {
    ...
    function z(t) {
      ...
      var r = e.Deferred();
      B = r.promise(),
      l.isConfigured() || tp.setUsePianoIdUserProvider(!0),
        gt(A);
      var i = n.getQueryParamByName(h);
      A.resetPasswordToken === undefined && i && (A.resetPasswordToken = i);
      var s = n.getQueryParamByName(p);
      A.passwordlessToken === undefined && s && (A.passwordlessToken = s);
      var o = n.getQueryParamByName(d);
      return o && (n.removeQueryParamByName(d),
      $t() || (tp.inappBrowserReturn = !0,
        U(o, !0))),
    ...
    function W(t, r) {
      ...
      var i = e.Deferred();
      return H = i.promise(),
        t && t.preview ? (setTimeout(i.resolve, 10),
          H) : (n.startCall("refreshUserToken"),
          z(t).then(function() {
            return A.passwordlessToken ? Z() : r ? e.when() : Jt()
          }).then(s, s),
          H)
    }
    function X() {
    ...
    function V(t) {
      W().then(function() {
        ...
        $t() ? at(r) : M ? (gt(t),
          n.log("Modal login window already shown")) : (gt(t),
          yt(r),
          Bt(r)),
          c.setTime("idShow")
      })
    ...
    function $() {
      ...
      const r = t === "registration" ? "email_is_not_confirmed" : "email_confirmation_required";
      var i = zt();
      Q({
        screen: r,
        email: i && i.email
    ...
    function Q(t) {
      ...
      t || (t = {});
      var r = e.extend({}, t, A);
      t.customEvents && typeof t.customEvents == "object" && (D = t.customEvents),
        yt(r),
        gt(t),
        Bt(r)
    }
    function G(t) {
      W().then(function() {
        ...
        var o = function() {
          if (M)
            n.log("Modal login window already shown");
          else {
            yt(r),
              gt(t);
            if (!r.preview && j) {
            ...
            if (!r.hideIfComplete)
              return e.extend(r, {
                readyCallback: function(e) {
                  i.send("setToken", Xt(), e.iframeId)
                }
              }),
                Bt(r);
            dn(r).then(function(t) {
    ...
    function Y() {
      i.send("submitLoginForm", null, M.iframeId)
    }
    function Z() {
      var t = e.Deferred();
      return e.ajax({
        url: Mt() + "api/v1/identity/passwordless/authorization/code",
        dataType: "jsonp",
        data: {
          aid: A.aid || tp.aid,
          passwordless_token: A.passwordlessToken
        },
        success: function(e) {
          e.error ? (tt(e),
            t.reject()) : (et(e),
    ...
    function nt(e) {
      var t = {
        ...
        , n = {
        passwordlessToken: e.passwordless_token,
        redirectUri: e.direction_url
      };
      rt(t, n)
    }
    function rt(e, t) {
    ...
    function it(t) {
      ...
      return st(r, 0, t.result.polling_timeouts, n.resolve),
        n.promise()
    }
    function st(e, t, r, i) {
      f.callApi("/anon/passwordless/check", e, function(s) {
        t++,
          s && s.result && s.result.poll_status !== "waiting" ? i(s) : !s.result && s.message ? (n.error("Passwordless purchase failed", s.message),
            i()) : t <= r.length ? setTimeout(function() {
            st(e, t, r, i)
          }, r[t - 1]) : i()
      })
    }
    ...
    function ut(e, t) {
      ...
      return e && (n.passwordlessToken = e.passwordlessToken,
        n.redirectUri = e.redirectUri),
        t ? Object.assign(n, t) : Object.assign(n, {
    ...
    function yt(e) {
      ...
      e.displayMode || (e.displayMode = "modal"),
        e.displayMode === "popup" ? (e.width = e.width || wt(),
          e.height = e.height || 460) : e.displayMode === "modal" && (e.width = e.width || wt()),
        e.accessToken = Rt()
    }
    function bt(e) {
      C = e
      ...
      function t(t) {
        ...
        switch (t.event) {
          ...
          case "loginSuccess":
            ...
            break;
          case "loginFailed":
            vt("loginFailed", t.params);
            break;
          case "registrationSuccess":
            Lt(t, function() {
              vt("registrationSuccess"),
                i.broadcast("pianoIdLoginSuccess", t.params)
            });
            break;
          case "registrationFailed":
            vt("registrationFailed", t.params);
            break;
          case "lang":
            en(t.params.lang, !0),
              yn(t.params.lang, e);
          ...
          case "cfAppImpression":
            s.__protected__.logCustomFormImpression(o, u, T);
            break;
          case "cfAppSubmission":
            s.__protected__.logCustomFormSubmission(o, u, T);
            break;
          ...
          case "screenReady":
            ...
            break;
          case "layoutReady":
            vt("layoutReady", t.params);
            break;
          case "confirmationEmailSent":
            e.config.displayMode !== "inline" && Yt(e);
            break;
          case "verificationCodeStartCheckout":
            ...
            try {
              ...
              n.log("error parse start checkout params"),
                f = {}
            }
            Yt(e, !0),
              Jt(!0, !0),
          ...
          case "passwordRestored":
            n.removeQueryParamByName("reset_token"),
              A.resetPasswordToken = undefined;
            break;
          case "emitGAEvent":
          ...
          case "redirect":
            ...
            break;
          case "designVersion":
            r.addClassToContainer(e, "piano-id-modal-ver-" + t.params.version);
            break;
          default:
    ...
    function Ct(t, n) {
      ...
      e.ajax({
        url: Mt() + "api/v1/identity/verification/code",
        dataType: "jsonp",
        data: {
          client_id: s,
          access_token: o,
    ...
    function Lt(e, t) {
      e && e.params && !e.params.areCookiesSet ? (e.params.source = E,
        j = !!e.params.registration,
        Vt(e.params).then(t)) : typeof t == "function" && t()
    }
    function At(e) {
      switch (e.params.event) {
        case "cfAppImpression":
        case "cfFormImpression":
          s.__protected__.logCustomFormImpression(e.params.trackingId, e.params.trackingId, N);
          break;
        case "cfFormSubmission":
          s.__protected__.logCustomFormSubmission(e.params.trackingId, e.params.trackingId, N);
          break;
        case "changeScreen":
          lt(e.params.params.screen, !0);
          break;
        case "loginFailed":
        case "registrationFailed":
        case "registrationSuccess":
          vt(e.params.event, e.params.params, !0);
          break;
        case "emitGAEvent":
    ...
    function Ot() {
      var e = tp.sandbox || tp.isNonProdEndpoint()
        , t = A.iframeUrl || tp.pianoIdUrl || !e && S || "/";
    ...
    function Pt(t, n, r, i) {
      ...
      return n.jsonpError && (s.jsonp_error = JSON.stringify(n.jsonpError)),
      ...
      r.pos && (s.width = r.pos.width,
        s.height = r.pos.height,
        s.top = r.pos.top,
        s.left = r.pos.left),
      n.templateId && (s.template_id = n.templateId),
      n.variantId && (s.variant_id = n.variantId),
        [t, e.param(s)].join("?")
    }
    function Ht(e, t) {
      var n = Dt()
    ...
    function Bt(t) {
      ...
      if (t.displayMode === "inline") {
        ...
        c = v.container,
          ...
          p = v.containerReady,
        t.observeContainer && (d = o.create(c, R))
        ...
        if (n.isIE()) {
          c = r.generateIframeWrapper(),
            f = Pt(Mt(), t, a, Mt() + "proxy.html"),
            a.iframeUrl = f,
            a.pos = r.getPopupPosition(a);
          var m = Pt(Mt() + "proxy.html", t, a);
          t.displayMode = "inlinePopup",
            h = r.generateIframe({}, a, m)
        } else {
      ...
      if (t.displayMode === "inline") {
        ...
        t.displayMode === "modal" ? c.append(h) : t.displayMode === "inlinePopup" && (c.append(h),
          e("body").append(c));
      n.debug("creating iframe: ", t),
        O.push(y);
      if (t.displayMode === "modal") {
        M = y,
          M.observer = d,
        (n.isIphone() || n.isSafariOrIOsUiWebView() || n.isAndroid()) && tp.containerUtils.__private__.mobileModalFix.modalOpened();
        var S = nn();
        yn(S, y)
      }
      return y
    ...
    function jt() {
      ...
      r.closeModal(M),
        M.element.remove(),
      M.observer && M.observer.disconnect(),
    ...
    function It(e) {
      if (!e || !e.user || !e.token)
        return;
      Ut(null, !0, !0);
      var t = Ft(e.cookie_domain);
      !e.extendExpiredAccessEnabled || qt(e.extendExpiredAccessEnabled, e.cookie_domain);
      if (e.user.rememberMe || un())
        t.expires = new Date(e.user.exp * 1e3),
          sn(t);
      n.__protected__.setCookie(v, e.token, t),
      e.cookie_domain && (t.expires = 30,
        n.__protected__.setCookie(g, e.cookie_domain, t))
    }
    function qt(e, t) {
      mn("setExtendExpiredAccess", e, "broadcast");
      var r = Ft(t);
      r.expires = 30,
        n.__protected__.setCookie(b, e ? "true" : "false", r)
    }
    function Rt() {
      var e = n.findCookieByName(v);
      return e ? e : null
    }
    function Ut(t, r, i) {
      var s = Ft()
      ...
      if (r)
        try {
          ...
          if (e) {
            ...
            s < i && (n.log("Removing expired tokens"),
              Ut(r),
              e = null)
          }
        } catch (o) {}
    ...
    function Wt(t) {
      ...
      dn(n).then(function(t) {
        ...
        typeof n.extendedUserLoaded == "function" && n.extendedUserLoaded(r),
          dt("extendedUserLoaded", r)
      })
    }
    function Xt() {
      return tp.externalJWT && l.isConfigured() ? tp.externalJWT : Rt()
    }
    function Vt(e, t, n) {
      It(e);
      var i = Gt(e).pipe(function() {
        !t && at(null, e.source)
      });
      n = n || e.withoutCloseModal;
      if (!n) {
        var s = e && e.user && e.user.email_confirmation_required
          , o = M && M.config && M.config.verification_code;
        s || o ? r.hideCloseButton() : Zt()
      }
      return i
    }
    function $t() {
      return l.isConfigured() ? !!tp.externalJWT : !!zt()
    }
    function Jt(r, i) {
      n.startCall("refreshUserToken");
      var s = e.Deferred()
        ...
        , u = function(e) {
        !e.error && e.access_token ? Vt({
          token: e.access_token,
          user: t(e.access_token),
          cookie_domain: e.site_cookie_domain,
          extendExpiredAccessEnabled: e.extend_expired_access_enabled
        }, r, i).then(o.bind(this, !0)) : (Ut(Xt()),
          o(!1))
      };
      const a = Xt() || undefined;
      return a ? e.ajax({
        url: Mt() + "api/v1/identity/token/validation",
        data: {
          client_id: A.aid || tp.aid,
        ...
        url: Mt() + "api/v1/identity/token/verify",
        data: {
          client_id: A.aid || tp.aid,
          site: document.location.origin || document.location.href
        },
    ...
    function Kt() {
      ...
      var r = (new Date).getTime()
        , i = n.__protected__.getCookie(b)
        , s = t(e)
        , o = r - s.login_timestamp > 864e5;
      i && o && Jt(!1, !0)
    }
    function Qt() {
      var t = e.Deferred();
      return e.ajax({
        url: Mt() + "api/v1/identity/logout",
        data: {
          client_id: A.aid || tp.aid
        },
        dataType: "jsonp",
        ...
        setTimeout(t.resolve, C),
        t.promise()
    }
    function Gt(t) {
      var n = e.Deferred()
        , r = !(t && t.user && t.user.rememberMe || un());
      return e.ajax({
        url: Mt() + "api/v1/identity/vxauth/cookie",
        data: {
          client_id: A.aid || tp.aid,
          session_cookie: r
        },
        headers: {
          Authorization: t.token || undefined
        },
        complete: n.resolve
      }),
        setTimeout(n.resolve, C),
        n.promise()
    }
    function Yt(e, t) {
      if (!e)
        return;
      t ? e.closed || (e.closed = !0,
        e.config.displayMode === "inline" ? e.container.empty() : e.config.displayMode === "popup" ? e.container.close() : e.config.displayMode === "modal" && (jt(e),
          e.container.parent().remove())) : (i.send("close", {}, e.iframeId),
    ...
    function en(e, t) {
      var r = Ft();
      r.expires = 30,
        n.__protected__.setCookie(m, e, r),
      t || O.forEach(function(t) {
        i.send("lang", {
          lang: e
        }, t.iframeId)
      }),
        Object.keys(_.langChangeFromIframe).forEach(function(t) {
          var n = _.langChangeFromIframe[t];
          i.__protected__.isIframeManaged(t) && n ? n(e) : delete _.langChangeFromIframe[t]
        }),
        vt("langChange", e)
    }
    function tn(e, t) {
      return _.langChangeFromIframe[t] = e,
        function() {
          delete _.langChangeFromIframe[t]
        }
    }
    function nn() {
      return tp.locale || n.__protected__.getCookie(m) || ""
    }
    function rn() {
      return n.__protected__.getCookie(y) || !1
    }
    function sn(e) {
      n.__protected__.setCookie(y, 1, e)
    }
    function on(t) {
      t && e.removeCookie(y, t)
    }
    function un() {
      return !!rn()
    }
    ...
    function dn(t) {
      var n = e.extend({}, A, t)
        , r = e.Deferred();
      return e.ajax({
        url: Mt() + "api/v1/identity/userinfo",
        data: {
          client_id: A.aid || tp.aid,
          form_name: n.formName
        },
        headers: {
          Authorization: Xt() || undefined
        },
        success: r.resolve,
        complete: function() {
          return r.resolve()
    ...
    function yn(e, t) {
      L.indexOf(e) >= 0 ? r.turnOnRTL(t) : r.turnOffRTL(t)
    }
    var h = "reset_token", p = "passwordless_token", d = "piano_social_token", v = n.getAidSpecifiedName("__utp"), m = "__pil", g = "__pid", y = "__idr", b = "__eea", w = "piano-id-container", E = "PIANOID", S = "https://id.tinypass.com", x = "show_form", T = "registration", N = "checkout", C = 300, k = 600, L = ["he_IL"], A = {}, O = [], M, _ = {
      loggedIn: [],
      loggedOut: [],
      loginSuccess: [],
      registrationSuccess: [],
      ...
      onShow: [],
      layoutReady: []
    }, D = {}, P = {}, H, B, j, F, I = [], q = ["G18rIJWQ2G", "45L2BaS6pu"];
    return e(window).resize(function() {
    ...
    }),
      {
        ...
        showEmailConfirmationRequired: J,
        submitLoginForm: Y,
        loginByToken: Et,
        logout: St,
        getToken: Xt,
        ...
        onLoginSuccess: an,
        onProfileUpdate: fn,
        onExtendedUserLoginRequired: ln,
        isUserValid: $t,
        setCallbacks: gt,
        getIframeUrl: Mt,
        updateLang: en,
        ...
        isAot: vn,
        registerCallback: pn,
        setRequestTimeout: bt,
        __protected__: {
          offerMessageReceiver: At,
          showEmailConfirmation: K,
          checkAndShowEmailIsNotConfirmed: $,
          closeModalContainer: jt,
          executePostMessagesBatch: gn
        },
        __private__: {
          prepareConfig: yt,
          extendUserToken: Kt,
  ...
  tp.define("observer", ["util", "jq"], function(e, t) {
    ...
    return s.prototype._mutationSearch = function() {
      ...
      this.targets.forEach(function(t) {
        ...
        !n === t.currentState && (t.currentState = n,
          e.callback([{
            target: t.element
          }]))
      }),
  ...
  tp.define("applePay", ["jq", "postmessage", "util"], function(e, t, n) {
    function m(e) {
      ...
      if (["loaded", "startCheckout"].indexOf(o.event) !== -1) {
        ...
        h = o.params.requestEmail,
          p = o.params.requestPostalAddress;
      else if (o.event === "applyTaxFailed")
        f.abort();
      else if (o.event === "checkApplePayBtInstance")
        l && t.broadcast("applePayInit", {});
      else if (o.event === "applyTaxCompleted")
        b(o.params.nonce);
    ...
    function g(e) {
      h && (e.requiredShippingContactFields = ["email"]),
      p && (e.requiredBillingContactFields = ["postalAddress"])
    }
    function y(e, n) {
      e.payment.shippingContact && (n.user = {
        email: e.payment.shippingContact.emailAddress
      });
      var r = e.payment.billingContact
        , i = {
        countryCode: r.countryCode ? r.countryCode.toUpperCase() : r.countryCode,
        zipCode: r.postalCode,
        billingZipCode: r.postalCode,
        nonce: n
      };
      t.broadcast("applePayPaymentAuthorized" + v, i)
    }
    function b(e) {
      f.completePayment(ApplePaySession.STATUS_SUCCESS),
        t.broadcast("applePayNonce" + v, e)
    }
    function w(e) {
      d = e,
        S()
    ...
    function N() {
      ...
      for (var t = 0, n = e.length; t < n; t++)
        if (e[t].src.indexOf(u) > -1)
          return !0
    }
    function C() {
      var e = document.getElementsByTagName("script");
      for (var t = 0, n = e.length; t < n; t++)
        if (e[t].src.indexOf(a) > -1)
          return !0
    }
    var r = 2, i = !1, s = !1, o = {}, u = "https://js.braintreegateway.com/web/3.22.2/js/client.min.js", a = "https://js.braintreegateway.com/web/3.22.2/js/apple-pay.min.js", f, l, c, h, p, d, v = "";
  ...
  tp.define("stripeApplePayIntegrationService", ["postmessage"], function(e) {
    function u() {
      ...
      if (!e) {
        ...
        return t.src = "https://js.stripe.com/v3/",
          t.id = "stripe.js",
    ...
    function a(n) {
      ...
      switch (t.event) {
        ...
        case "stripe-applepay-abort-request":
          i && i.abort(),
            e.broadcast("stripe-applepay-reopen-request")
      }
      return {
  ...
  tp.define("obi3DSChallenge", ["postmessage", "jq", "util"], function(e, t, n) {
    function i(t) {
      if (t.stepUpUrl && t.stepUpUrl.indexOf("http") !== 0) {
      ...
      obick.handle3dsChallenge(r).then(function(t) {
        console.warn(t),
    ...
    function s(e) {
      ...
      if (r.event === "obi-handle-3ds-challenge") {
        var n = r.params;
        if (!window.obick) {
          const s = ["https://jsl.qat.obi.aol.com/obipmservice/obick.umd.js", "https://jsl.prod.obi.aol.com/obipmservice/obick.umd.js"];
          if (s.indexOf(n.obickUrl) === -1) {
            console.warn("Untrusted obickUrl detected: " + n.obickUrl);
            return
          }
  ...
  tp.define("log", ["jq", "util", "postmessage"], function(e, t, n) {
    ...
    var r = function() {
      ...
      r.length > 6e3 ? e.ajax({
        ...
        url: tp.getTrackingEndpoint() + t + "?" + r,
        dataType: "jsonp"
      })
    }
      , o = function(e, n, r) {
      ...
      s("/api/v3/conversion/logMicroConversion", i)
    }
      , u = function(e, n, r, i, o) {
      var u = {
        tracking_id: e,
        esp_widget_id: n,
        event_type: i,
      ...
      s("/api/v3/conversion/logEspMicroConversion", u)
    }
      , a = function(e, n, r, i, o, u, a, f) {
      var l = {
        tracking_id: e,
        term_id: n,
        term_name: r
      ...
      typeof i != "undefined" && (l.step_number = i),
      ...
      typeof f != "undefined" && (l.conversion_category = f),
        s("/api/v3/conversion/log", l)
    }
      , f = function(e) {
      typeof e == "object" ? a(e.tracking_id, e.term_id, e.term_name, e.step_number, e.amount, e.currency, e.custom_params, e.conversion_category) : a.apply(this, arguments)
    }
      , l = function(e, n, r, i) {
      var o = {
        tracking_id: e,
      ...
      s("/api/v3/conversion/logFunnelStep", o)
    }
      , c = function(e, n, r) {
      ...
      return o && (i.user_token = o),
      e && (i.tracking_id = e),
        s("/api/v3/customform/log/impression", i)
    }
      , h = function(e, n, r) {
      ...
      return o && (i.user_token = o),
      e && (i.tracking_id = e),
        s("/api/v3/customform/log/submission", i)
    }
      , p = function(n, s) {
      if (r())
        return;
      ...
      if (navigator.sendBeacon)
        if (u.length > 6e3) {
          ...
          navigator.sendBeacon(n, a)
        } else
          navigator.sendBeacon(u);
      else {
        var f = navigator.appVersion.indexOf("MSIE 9") !== -1, l;
        f ? l = {
          dataType: "jsonp",
          url: u
        } : l = {
    ...
    return {
      name: "log",
      logMicroConversion: o,
      logConversion: f,
      logFunnelStep: l,
      logEspMicroConversion: u,
      logBeaconRequest: p,
      __protected__: {
        logCustomFormImpression: c,
        logCustomFormSubmission: h,
        logEspMicroConversion: u
      },
      __private__: {
        doLog: s,
  ...
  tp.define("gaService", ["jq", "api", "util", "postmessage"], function(e, t, n, r) {
    ...
    function O() {
      var n = e.Deferred();
      return t.callApi("/anon/assets/gaAccount", {
        aid: tp.aid
      }, function(e) {
        e.code === 0 ? (_(e.data),
          n.resolve()) : n.reject()
    ...
    function M() {
      var n = e.Deferred();
      return t.callApi("/anon/assets/performanceMetrics", null, function(e) {
        e.code === 0 ? (D(e.performance_metrics_dto),
          n.resolve()) : n.reject()
      }),
        n.promise()
    }
    ...
    function P() {
      var t = e.Deferred();
      return h.isGAEnabled ? B().then(function() {
        if (h.isGAAppended)
    ...
    function H() {
      var t = e.Deferred();
      return h.isMetricsEnabled ? B().then(function() {
        if (h.isGAAppended)
          if (!h.isMetricsTrackerAppended)
            try {
              var e = !h.trackOnlyAids.length || h.trackOnlyAids.contains(tp.aid)
                , n = document.createElement("script");
              n.innerHTML = "ga(function() {  if(" + e + ") {" + "    ga('create', '" + h.metricsGAAccount + "', 'auto', '" + o + "'," + "       { storage: 'none' });" + "    tp.gaService.metricsTrackerAppended();" + "  }" + "});",
    ...
    function B() {
      ...
      if (h.isGAAppended)
        ...
        try {
          var n = document.createElement("script");
          n.innerHTML = "(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','https://www.google-analytics.com/analytics.js','ga');",
            document.head.appendChild(n),
            h.isGAAppended = !0,
            t.resolve()
        } catch (r) {
    ...
    function j() {
      var e = "ga(function() {  ga('create', '" + h.gaAccount + "', 'auto', '" + s + "'";
      return d ? e += ", { clientId: '" + d + "' });" : e += ");  tp.gaService.setClientId(ga.getByName('" + s + "').get('clientId'));",
        e += "tp.gaService.trackerAppended(); });",
        e
    }
    var i = {
      name: "gaService",
    ...
    return i.emitEvent = function(e) {
      ...
      ,
      i.recreateWithClientId = function(e) {
        d = e,
          w()
      }
      ,
      ...
      i.trackerAppended = function() {
        h.isTrackerAppended = !0,
          r.broadcast("gaAppended", {
            clientId: d,
            gaAccount: h.gaAccount
          }),
          g = !1,
          T()
      }
  ...
  tp.define("pianoEsp", ["jq", "util", "log", "recWidgetService", "user", "api"], function(e, t, n, r, i, s) {
    var o = "__pnml", u, a = "EXTERNAL_LINK", f = "EXTERNAL_EVENT", l = r.__protected__.getInstance(), c = "300", h = {
      granted: "ALLOWED",
      "default": "UNKNOWN",
      denied: "FORBIDDEN"
    }, p = function() {
      ...
      return i.id ? (e.extend(i, {
        ...
        r.__protected__.insertWidgetLib({
          id: "pnesplucidsdksel",
          src: v() + "/public/sdk/v04/sdk.js?v=" + (localStorage && localStorage.lucidsdkver || "xxx"),
          onerror: n.reject
        })) : n.reject(),
        u = n.promise(),
        u
      ...
      p().then(function() {
        window.PianoESP.getCurrentPushState().then(function(e) {
          ...
          window.PianoESP.subscribeToPushSquads([e]).then(function(i) {
            var s = i || {};
            s.result === !0 ? (t.setPushListsCookie(e),
              t.debug("pianoESP: Push notification was set:", s),
              n.logMicroConversion(r, "enrollPushCampaign")) : s.result === !1 && (s.reason === "closed" ? n.logMicroConversion(r, "closePrompt") : n.logMicroConversion(r, "declineEnrollPushCampaign"))
          }).catch(function(e) {
      ...
      var t = e || {};
      t.templateId ? (n.logMicroConversion(t.trackingId, "showPushSignupTemplate"),
        tp.template.show({
      ...
      try {
        ...
        t.debug("can't load mailing lists from storage", n.message)
      }
      return e || []
    }, S = function(e) {
      ...
      switch (e.event) {
        case "newsletterSignupSubmission":
          var t = E();
          t.indexOf(e.params.mailingListIds) === -1 && (t.push(e.params.mailingListIds),
            w(t))
      }
    }, T = function(t) {
      return function() {
    ...
    return setTimeout(function() {
    ...
    }, c),
      {
        ...
        __protected__: {
          ...
          loadCompleteMailingLists: E
        },
        __private__: {
          removeWidgetsAndSdk: C,
          getWidgetCallbacks: N,
          onInit: k
        }
      }
  }),
  tp.define("versionService", [], function() {
    ...
    var e = "12.126.3, server-v12.126.3";
    return n(),
      {
        name: "versionService",
  ...
  tp.define("amp", ["jq", "util", "api", "user", "pianoId"], function(e, t, n, r, i) {
    ...
    function u(n) {
      if (n && n.userState && e.isPlainObject(n.userState)) {
        ...
        if (r.filter(s.__private__.isUserStateNameValid).length !== r.length)
          return t.error("user_state accept only contain letters, numbers and underscore"),
            !1
      }
      return !0
    }
    ...
    function c(t) {
      ...
      t && t.userProvider && (o.user_provider = t.userProvider,
        o.user_transient = !1);
      if (!u(t))
        return !1;
  ...
  tp.define("performanceMetrics", ["postmessage"], function(e) {
    ...
    }], n = !1, r, i = [], s = "EVENT_TP_PERFORMANCE_DATA", o = "EVENT_LOGGER_READY";
    return u(),
      {
  ...
  tp.define("swg", ["postmessage", "user", "jq", "util", "eventUtils"], function(e, t, n, r, i) {
    ...
    function p(e) {
      ...
      return tp.api.callApi("/swg/check", {
        ...
        e.code !== 0 && (r.log("swg: check subscription response - " + e.message),
          t.reject()),
    ...
    function d(e) {
      ...
      return tp.api.callApi("/swg/check/external", {
        ...
        e.code !== 0 && (r.log("swg: check external entitlement response - " + e.message),
          t.reject());
        var n = e.data;
        n || (r.log("swg: check external entitlement empty response"),
          t.reject()),
          t.resolve(n)
      }),
        t.promise()
    ...
    var s = "externalCheckoutComplete", o = {
      LOGIN_PROMPT: "loginPrompt",
      DEFERRED_ACCOUNT_CREATION: "deferredAccountCreation",
      BUY: "buy"
    }, u = i.createEventManager([s]), a = !1, f = !1, l;
    ...
    var c = function() {
      window.SWG.push(function(e) {
        e.getEntitlements().then(function(t) {
          a = !0,
            r.debug("swg: getEntitlements", t);
          if (t.enablesThis()) {
            var n = t.getEntitlementForSource("google");
            if (!n) {
              var i = t.entitlements;
              i && d(i).then(function() {
                r.debug("swg: checkExternalEntitlement"),
                  t.ack()
              }, function() {
  ...
  tp.define("fbsubscriptions", ["jq", "util", "fbpixel", "offer", "pianoId", "user", "api"], function(e, t, n, r, i, s, o) {
    ...
    function m() {
      ...
      a && (n += "&subscription_payload=" + encodeURIComponent(a)),
        window.location = n
    }
    function g() {
      p().then(function() {
  ...
  tp.define("tinypassErrorHandler", ["postmessage", "api", "log", "versionService", "util"], function(e, t, n, r, i) {
    function d(e, t) {
      var n = e.map(function(e) {
    ...
    function y(e) {
      return e && e.indexOf("tinypass") === -1
    }
    function b() {
      var e = !!i.__protected__.getLocalStorageItem("tinypassErrorHandlerTestMode");
      return e || T(0, u) === 0
    }
    function w() {
      e.subscribe(s, m),
      window.addEventListener && window.addEventListener("error", g)
    }
    function E() {
    ...
    function x(e, t) {
      try {
        ...
        e instanceof Error ? (n.stack = e.stack,
          n.message = e.message) : n.stack = JSON.stringify(e);
        if (c) {
          var r = n.tags || [];
          n.tags = r.concat(f)
        }
  ...
  tp.define("newscycle", ["jq", "user", "api", "postmessage", "util"], function(e, t, n, r, i) {
    function o() {
      var t = e.Deferred()
        , r = {
        aid: tp.aid
    ...
    return s.name = "newscycle",
      s.syncSubscriptions = i.debounce(f, 1500),
      s.__private__.SYNCHRONIZE_SUBSCRIPTIONS_URL = "/externalVerification/synchronizeSubscriptions",
  ...
  tp.define("cxense", ["jq", "util", "recWidgetService"], function(e, t, n) {
    var r = n.__protected__.getInstance()
      ...
      t.debug("c1x: setting siteId: ", e),
        window.cX.setSiteId(e)
    }
      , s = function() {
      ...
      , a = function(e) {
      return typeof window.cX != "undefined" && typeof window.cX.library != "undefined" && (e || typeof window.cX.CCE != "undefined" && typeof window.cX.CCE.library != "undefined")
    }
      , f = function(e) {
      ...
      var r = "anon";
      e.uid && e.uid !== "anon" && e.uid !== "" && (r = e.eventExecutionContext && e.eventExecutionContext.accessList.length ? "hasActiveAccess" : "registered",
        n.callQueue.push(["addExternalId", {
          id: e.uid,
        ...
        n.callQueue.push(["setCustomParameters", {
          userState: r
        }]),
        t.debug("c1x: adding CustomParameters userState", {
          userState: r
        }),
        ...
        tp.c1XLoadCce ? (n.CCE = n.CCE || {},
          n.CCE.callQueue = n.CCE.callQueue || [],
          n.CCE.callQueue.push(["sendPageViewEvent"])) : n.callQueue.push(["sendPageViewEvent"])
    }
      , h = function() {
      ...
      var i = e || n;
      return i ? (t.debug("c1x: existing cX_P value has been found: ", i),
        i) : (t.debug("c1x: can not find existing cX_P value, generating a new one"),
      ...
      var i = 0
        , s = e.Deferred()
        , o = function() {
        g(t) ? s.resolve(!0) : i >= r ? s.reject(t ? "c1x: cX object is not found after " + r + " retries with " + n + "ms interval" : "c1x: cX and cX.CCE objects are not found after " + r + " retries with " + n + "ms interval") : (i++,
          setTimeout(o, n))
      };
      return g(t) ? s.resolve(!0) : setTimeout(o, n),
        s
    };
    return {
      name: "cxense",
  ...
  tp.define("recWidgetService", ["jq", "util", "containerUtils"], function(e, t, n) {
    var r = function(e) {
      ...
      if (r(t)) {
        ...
        i(t) && (o = n.getModalContainer(t, function() {
          e.isFunction(s) && s()
        }));
      return o
    }
      ...
      var a = []
        ...
        i(v) && (f = p,
        (t.isIphone() || t.isSafariOrIOsUiWebView() || t.isAndroid()) && n.__private__.mobileModalFix.modalOpened()),
        ...
        var n = t || {}
          , s = n.widget || {};
        r(s.config) ? s.container.empty() : i(s.config) && (v(s),
          s.container.detach()),
  ...
  tp.define("sha1", [], function() {
    function e(e, t) {
      ...
      t = t || 32;
      var o, u, a, f = new Array(80), l = 1732584193, c = 4023233417, h = 2562383102, p = 271733878, d = 3285377520, v, m, g, y, b, w;
      e = s(e);
      var E = e.length
        , S = new Array;
      for (u = 0; u < E - 3; u += 4)
        a = e.charCodeAt(u) << 24 | e.charCodeAt(u + 1) << 16 | e.charCodeAt(u + 2) << 8 | e.charCodeAt(u + 3),
          S.push(a);
      switch (E % 4) {
        case 0:
          u = 2147483648;
      ...
      while (S.length % 16 != 14)
        S.push(0);
      S.push(E >>> 29),
        S.push(E << 3 & 4294967295);
      for (o = 0; o < S.length; o += 16) {
        for (u = 0; u < 16; u++)
          f[u] = S[o + u];
        for (u = 16; u <= 79; u++)
          f[u] = n(f[u - 3] ^ f[u - 8] ^ f[u - 14] ^ f[u - 16], 1);
        v = l,
          m = c,
          g = h,
          y = p,
  ...
  tp.define("itp", ["jq"], function(e) {
    ...
    var t, n = tp.cloudflareWorkerUrl, r = 3600;
    return {
      name: "itp",
      synchronizeCookie: i
    }
  }),
  tp.define("captchaV3", ["util", "api", "postmessage", "jq"], function(e, t, n, r) {
    function s(t) {
      t && e.error(t)
    }
    function o(e, t) {
      e.config && e.config.enabled ? (i = e.config,
      t && t()) : s(e.message)
    }
    function u(e) {
      r.ajax({
        url: tp.getApiEndpoint() + "/anon/captcha/get.js",
        data: {
          aid: tp.aid
        },
        dataType: "jsonp",
    ...
    function f() {
      grecaptcha.render("tp-recaptcha", {
        sitekey: i.captcha3_site_key,
        size: "invisible"
      })
    }
    function l() {
      window.onCaptchaV3Load = a;
      var e = "https://www.google.com/recaptcha/api.js?onload=onCaptchaV3Load&render=explicit"
    ...
    function c() {
      window.addEventListener("message", h.bind(this), !1)
    }
    function h(e) {
      try {
      ...
      switch (t.event) {
        case "get-captcha-v3-enabled":
          p();
          break;
        case "get-captcha-v3-token":
    ...
    function p() {
      n.broadcast("captcha-v3-enabled-value", {
        isEnabled: i.enabled
      })
    }
    function d(e) {
