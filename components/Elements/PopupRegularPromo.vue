<template>
  <transition name="fade">
    ...
    >
      <div
        class="full flex stretch zgt-salebox sepia-salebox relative alt-salebox"
      >
        <div
          v-if="softwall"
...
export default {
  ...
  data() {
    return {
      ...
      oldPrice: false,
      newPrice: false,
      packName: 'Iskoristite jedinstvenu ponudu – ',
      termDurationText: 'doživotni pristup Telegramu',
      subtitle:
