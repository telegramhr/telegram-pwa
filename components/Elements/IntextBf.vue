<template>
  <transition name="fade">
    <div
      ...
      data-nosnippet
    >
      <div class="full flex zgt-salebox dark-zgt-salebox relative">
        <img
        ...
        <div class="forty flex-responsive m-order-2 flex relative">
          <div class="full noththree overtitle">
            {{ packName }}
          </div>
        ...
        <div
          class="sixty flex-responsive column-full-pad mobile-bottom-pad flex relative m-order-1"
        >
          <img
